...
def define_common_upstream_files():
    ...
    copy_file(
        name = "copied-arm-smmu-v3-common-lib",
        src = "drivers/iommu/arm/arm-smmu-v3/arm-smmu-v3-common-lib.c",
        out = "drivers/iommu/arm/arm-smmu-v3/pkvm/arm-smmu-v3-common-lib.c",
    )
