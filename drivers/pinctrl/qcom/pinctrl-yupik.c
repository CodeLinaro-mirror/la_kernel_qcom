...
static const char *const egpio_groups[] = {
	...
	"gpio162", "gpio163", "gpio164", "gpio165", "gpio166", "gpio171",
...
static const struct msm_pingroup yupik_groups[] = {
	[0] = PINGROUP(0, qup00, ibi_i3c, NA, NA, NA, NA, NA, NA, NA,
		       NA, NA, 0xAF00C, 1),
	[1] = PINGROUP(1, qup00, ibi_i3c, NA, NA, NA, NA, NA, NA, NA, NA,
		       NA, 0, -1),
	...
	[4] = PINGROUP(4, qup01, ibi_i3c, NA, NA, NA, NA, NA, NA, NA,
		       NA, NA, 0xAF00C, 3),
	[5] = PINGROUP(5, qup01, ibi_i3c, NA, NA, NA, NA, NA, NA, NA, NA,
		       NA, 0, -1),
	[6] = PINGROUP(6, qup01, qup07, NA, NA, NA, NA, NA, NA, NA, NA, NA,
		       0, -1),
	[7] = PINGROUP(7, qup01, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
		       0xAF00C, 4),
	[8] = PINGROUP(8, qup02, NA, qdss_gpio2, NA, NA, NA, NA, NA, NA,
		       NA, NA, 0xAF00C, 5),
	[9] = PINGROUP(9, qup02, NA, qdss_gpio3, NA, NA, NA, NA, NA, NA, NA,
		       NA, 0, -1),
	...
	[12] = PINGROUP(12, qup03, qspi_data, sdc40, tb_trig, phase_flag31,
			qdss_gpio, ddr_pxi1, NA, NA, NA, NA, 0xAF00C, 7),
	[13] = PINGROUP(13, qup03, qspi_data, sdc41, tb_trig, phase_flag30,
			qdss_gpio, ddr_pxi1, NA, NA, NA, NA, 0, -1),
	...
	[15] = PINGROUP(15, qup03, qspi_cs, tb_trig, phase_flag28, qdss_cti,
			ddr_pxi0, NA, NA, NA, NA, NA, 0xAF00C, 8),
	[16] = PINGROUP(16, qup04, qspi_data, sdc42, mdp_vsync, phase_flag27,
			qdss_cti, NA, NA, NA, NA, NA, 0xAF00C, 9),
	...
	[19] = PINGROUP(19, qup04, qspi_cs, sdc4_cmd, NA, phase_flag24,
			qdss_cti, NA, NA, NA, NA, NA, 0xAF00C, 11),
	...
	[29] = PINGROUP(29, qup07, qdss_gpio15, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[30] = PINGROUP(30, qup07, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[31] = PINGROUP(31, qup07, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0xAF010, 3),
	[32] = PINGROUP(32, qup10, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0xAF000, 3),
	[33] = PINGROUP(33, qup10, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[34] = PINGROUP(34, qup10, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0xAF000, 4),
	[35] = PINGROUP(35, qup10, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0xAF000, 5),
	[36] = PINGROUP(36, qup11, ibi_i3c, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0xAF000, 6),
	[37] = PINGROUP(37, qup11, ibi_i3c, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[38] = PINGROUP(38, qup11, qup14, dbg_out, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[39] = PINGROUP(39, qup11, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0xAF000, 7),
	[40] = PINGROUP(40, qup12, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0xAF000, 8),
	[41] = PINGROUP(41, qup12, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0xAF000, 9),
	[42] = PINGROUP(42, qup12, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[43] = PINGROUP(43, qup12, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0xAF000, 10),
	[44] = PINGROUP(44, qup13, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0xAF000, 11),
	[45] = PINGROUP(45, qup13, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0xAF000, 12),
	[46] = PINGROUP(46, qup13, edp_lcd, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[47] = PINGROUP(47, qup13, dp_hot, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0xAF000, 13),
	[48] = PINGROUP(48, qup14, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0xAF000, 14),
	[49] = PINGROUP(49, qup14, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[50] = PINGROUP(50, qup14, qup16, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[51] = PINGROUP(51, qup14, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0xAF000, 15),
	[52] = PINGROUP(52, qup15, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0xAF004, 0),
	[53] = PINGROUP(53, qup15, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	...
	[68] = PINGROUP(68, cam_mclk, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0xAF010, 4),
	[69] = PINGROUP(69, cci_i2c, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[70] = PINGROUP(70, cci_i2c, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[71] = PINGROUP(71, cci_i2c, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[72] = PINGROUP(72, cci_i2c, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0xAF010, 5),
	[73] = PINGROUP(73, cci_i2c, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[74] = PINGROUP(74, cci_i2c, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	...
	[77] = PINGROUP(77, cci_timer2, gcc_gp2, NA, atest_usb13, atest_char0,
			NA, NA, NA, NA, NA, NA, 0xAF010, 7),
	[78] = PINGROUP(78, cci_timer3, cci_async, gcc_gp3, NA, atest_usb12,
			atest_char1, NA, NA, NA, NA, NA, 0xAF010, 8),
	...
	[81] = PINGROUP(81, mdp_vsync, dp_lcd, mdp_vsync2, mdp_vsync3,
			mdp_vsync5, atest_usb1, atest_char, NA, NA, NA, NA,
			0xAF004, 6),
	[82] = PINGROUP(82, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0xAF018, 3),
	[83] = PINGROUP(83, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0xAF010, 10),
	[84] = PINGROUP(84, usb2phy_ac, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[85] = PINGROUP(85, usb2phy_ac, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[86] = PINGROUP(86, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0xAF010, 11),
	[87] = PINGROUP(87, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[88] = PINGROUP(88, pcie0_clkreqn, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0xAF010, 12),
	[89] = PINGROUP(89, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0xAF010, 13),
	[90] = PINGROUP(90, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0xAF010, 14),
	[91] = PINGROUP(91, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0xAF010, 15),
	[92] = PINGROUP(92, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0xAF018, 4),
	...
	[95] = PINGROUP(95, lpass_slimbus, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0xAF004, 7),
	[96] = PINGROUP(96, pri_mi2s, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[97] = PINGROUP(97, mi2s0_sck, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[98] = PINGROUP(98, mi2s0_data0, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[99] = PINGROUP(99, mi2s0_data1, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	...
	[108] = PINGROUP(108, mi2s1_ws, NA, qdss_gpio7, NA, NA, NA, NA, NA, NA,
			 NA, NA, 0, -1),
	[109] = PINGROUP(109, uim1_data, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[110] = PINGROUP(110, uim1_clk, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[111] = PINGROUP(111, uim1_reset, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, NA, 0, -1),
	[112] = PINGROUP(112, uim1_present, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, NA, 0xAF018, 5),
	[113] = PINGROUP(113, uim0_data, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[114] = PINGROUP(114, uim0_clk, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	...
	[131] = PINGROUP(131, mss_grfc12, nav_gpio2, pa_indicator, phase_flag1,
			 NA, NA, NA, NA, NA, NA, NA, 0xAF014, 10),
	...
	[138] = PINGROUP(138, qlink1_wmss, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, NA, 0, -1),
	[139] = PINGROUP(139, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[140] = PINGROUP(140, usb_phy, pll_clk, NA, NA, NA, NA, NA, NA, NA,
			 NA, NA, 0xAF018, 7),
	[141] = PINGROUP(141, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0xAF018, 8),
	[142] = PINGROUP(142, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0xAF018, 9),
	[143] = PINGROUP(143, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0xAF018, 10),
	[144] = PINGROUP(144, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0, -1),
	[145] = PINGROUP(145, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0xAF004, 12),
	[146] = PINGROUP(146, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0, -1),
	[147] = PINGROUP(147, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0, -1),
	[148] = PINGROUP(148, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0xAF004, 13),
	[149] = PINGROUP(149, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0, -1),
	...
	[153] = PINGROUP(153, qdss_gpio11, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, egpio, 0xAF008, 0),
	[154] = PINGROUP(154, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0, -1),
	[155] = PINGROUP(155, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0xAF008, 1),
	[156] = PINGROUP(156, qdss_cti, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, egpio, 0xAF008, 2),
	[157] = PINGROUP(157, qdss_cti, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, egpio, 0xAF008, 3),
	[158] = PINGROUP(158, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0xAF008, 4),
	[159] = PINGROUP(159, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0xAF008, 5),
	[160] = PINGROUP(160, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0, -1),
	[161] = PINGROUP(161, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0xAF008, 6),
	[162] = PINGROUP(162, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0, -1),
	[163] = PINGROUP(163, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0xAF008, 7),
	[164] = PINGROUP(164, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0, -1),
	[165] = PINGROUP(165, qdss_cti, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0, -1),
	[166] = PINGROUP(166, qdss_cti, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, egpio, 0xAF008, 8),
	[167] = PINGROUP(167, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[168] = PINGROUP(168, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[169] = PINGROUP(169, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[170] = PINGROUP(170, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
