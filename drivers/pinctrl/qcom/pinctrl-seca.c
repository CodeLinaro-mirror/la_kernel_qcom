...
static const struct pinctrl_pin_desc seca_pins[] = {
...
static const unsigned int ufs1_reset_pins[] = { 182 };
...
static const char *const tsense_clm_groups[] = {
	"gpio36", "gpio37", "gpio38", "gpio43", "gpio44", "gpio45",
	"gpio46",
};
...
static const struct pinfunction seca_functions[] = {
	...
	FUNCTION(qup3_se0_l0_mira),
	FUNCTION(qup3_se0_l0_mirb),
	FUNCTION(qup3_se0_l1_mira),
	FUNCTION(qup3_se0_l1_mirb),
 ...
 */
static const struct msm_pingroup seca_groups[] = {
	[0] = PINGROUP(0, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[1] = PINGROUP(1, pcie0_clk_req_n, NA, NA, NA, NA, NA, NA, NA, NA, NA,
		       NA, 0, -1),
	[2] = PINGROUP(2, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[3] = PINGROUP(3, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[4] = PINGROUP(4, pcie1_clk_req_n, NA, NA, NA, NA, NA, NA, NA, NA, NA,
		       NA, 0, -1),
	[5] = PINGROUP(5, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[6] = PINGROUP(6, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[7] = PINGROUP(7, pcie2_clk_req_n, NA, NA, NA, NA, NA, NA, NA, NA, NA,
		       NA, 0, -1),
	[8] = PINGROUP(8, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[9] = PINGROUP(9, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[10] = PINGROUP(10, pcie3_clk_req_n, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, 0, -1),
	[11] = PINGROUP(11, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[12] = PINGROUP(12, usb0_hs, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0,
			-1),
	[13] = PINGROUP(13, usb1_hs, gcc_gp7_clk, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[14] = PINGROUP(14, usb2_hs, gcc_gp8_clk, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[15] = PINGROUP(15, ccu_i2c_sda0, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, 0, -1),
	[16] = PINGROUP(16, ccu_i2c_scl0, emac0_mcg0, NA, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[17] = PINGROUP(17, ccu_i2c_sda1, emac0_mcg1, NA, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[18] = PINGROUP(18, ccu_i2c_scl1, emac0_mcg2, NA, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[19] = PINGROUP(19, ccu_i2c_sda2, emac0_mcg3, NA, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[20] = PINGROUP(20, ccu_i2c_scl2, emac1_mcg0, NA, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[21] = PINGROUP(21, ccu_i2c_sda3, emac1_mcg1, NA, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[22] = PINGROUP(22, ccu_i2c_scl3, emac1_mcg2, NA, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[23] = PINGROUP(23, ccu_i2c_sda4, emac1_mcg3, NA, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[24] = PINGROUP(24, ccu_i2c_scl4, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, 0, -1),
	[25] = PINGROUP(25, ccu_timer0, tsc_timer0, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[26] = PINGROUP(26, ccu_timer1, tsc_timer1, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[27] = PINGROUP(27, ccu_timer2, tsc_timer2, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[28] = PINGROUP(28, ccu_timer3, tsc_timer3, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[29] = PINGROUP(29, ccu_timer4, tsc_timer4, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[30] = PINGROUP(30, ccu_timer5, tsc_timer5, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[31] = PINGROUP(31, ccu_timer6, tsc_timer6, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[32] = PINGROUP(32, ccu_timer7, tsc_timer7, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[33] = PINGROUP(33, ccu_timer8, tsc_timer8, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[34] = PINGROUP(34, ccu_timer9, tsc_timer9, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[35] = PINGROUP(35, dp_rx0_mute, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[36] = PINGROUP(36, ddr_bist_start, tsense_clm, NA, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[37] = PINGROUP(37, emac1_ptp, ddr_bist_complete, tsense_clm, NA, NA,
			NA, NA, NA, NA, NA, NA, 0, -1),
	[38] = PINGROUP(38, emac1_ptp, ddr_bist_stop, tsense_clm, NA, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[39] = PINGROUP(39, emac1_ptp, ddr_bist_fail, NA, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[40] = PINGROUP(40, emac1_ptp, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[41] = PINGROUP(41, emac1_ptp, qdss_cti, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, 0, -1),
	[42] = PINGROUP(42, emac1_ptp, qdss_cti, gcc_gp3_clk, NA, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[43] = PINGROUP(43, emac1_ptp, gcc_gp4_clk, tsense_clm, tsense_pwm1, NA,
			NA, NA, NA, NA, NA, NA, 0, -1),
	[44] = PINGROUP(44, emac1_ptp, tsense_clm, tsense_pwm2, NA, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[45] = PINGROUP(45, usxgmii0_phy, ccu_async_in5, tsense_clm,
			tsense_pwm3, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[46] = PINGROUP(46, usxgmii1_phy, tsense_clm, tsense_pwm4, NA, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[47] = PINGROUP(47, emac0_mdc, edp0_lcd, tsense_pwm5, NA, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[48] = PINGROUP(48, emac0_mdio, edp1_lcd, tsense_pwm6, NA, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[49] = PINGROUP(49, emac1_mdc, edp2_lcd, tsense_pwm7, NA, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[50] = PINGROUP(50, emac1_mdio, tsense_pwm8, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[51] = PINGROUP(51, edp0_hot, aoss_cti, gcc_gp1_clk, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[52] = PINGROUP(52, edp1_hot, aoss_cti, gcc_gp2_clk, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[53] = PINGROUP(53, edp2_hot, aoss_cti, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, 0, -1),
	[54] = PINGROUP(54, aoss_cti, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0,
			-1),
	[55] = PINGROUP(55, dp_rx0, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0,
			-1),
	[56] = PINGROUP(56, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[57] = PINGROUP(57, aud_intfc0_clk, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, 0, -1),
	[58] = PINGROUP(58, aud_intfc0_ws, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, 0, -1),
	[59] = PINGROUP(59, aud_intfc0_data0, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[60] = PINGROUP(60, aud_intfc0_data1, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[61] = PINGROUP(61, aud_intfc0_data2, aud_intfc10_clk, NA, NA, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[62] = PINGROUP(62, aud_intfc0_data3, aud_intfc10_ws, NA, NA, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[63] = PINGROUP(63, aud_intfc0_data4, aud_intfc7_clk, NA, NA, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[64] = PINGROUP(64, aud_intfc0_data5, aud_intfc7_ws, NA, NA, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[65] = PINGROUP(65, aud_intfc0_data6, aud_intfc7_data0, NA, NA, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[66] = PINGROUP(66, aud_intfc0_data7, aud_intfc7_data1, qdss_gpio, NA,
			NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[67] = PINGROUP(67, aud_intfc1_clk, phase_flag18, NA, qdss_gpio0, NA,
			NA, NA, NA, NA, NA, NA, 0, -1),
	[68] = PINGROUP(68, aud_intfc1_ws, phase_flag19, NA, qdss_gpio1, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[69] = PINGROUP(69, aud_intfc1_data0, phase_flag20, NA, qdss_gpio2, NA,
			NA, NA, NA, NA, NA, NA, 0, -1),
	[70] = PINGROUP(70, aud_intfc1_data1, aud_intfc9_clk, phase_flag21, NA,
			qdss_gpio3, NA, NA, NA, NA, NA, NA, 0, -1),
	[71] = PINGROUP(71, aud_intfc1_data2, aud_intfc9_ws, phase_flag22, NA,
			qdss_gpio4, NA, NA, NA, NA, NA, NA, 0, -1),
	[72] = PINGROUP(72, aud_intfc1_data3, aud_intfc9_data0, phase_flag23,
			NA, qdss_gpio5, NA, NA, NA, NA, NA, NA, 0, -1),
	[73] = PINGROUP(73, aud_intfc1_data4, aud_intfc8_clk, phase_flag24, NA,
			qdss_gpio6, NA, NA, NA, NA, NA, NA, 0, -1),
	[74] = PINGROUP(74, aud_intfc1_data5, aud_intfc8_ws, phase_flag25, NA,
			qdss_gpio7, NA, NA, NA, NA, NA, NA, 0, -1),
	[75] = PINGROUP(75, aud_intfc1_data6, aud_intfc8_data0, phase_flag26,
			NA, qdss_gpio, NA, NA, NA, NA, NA, NA, 0, -1),
	[76] = PINGROUP(76, aud_intfc1_data7, aud_intfc8_data1, phase_flag27,
			NA, qdss_gpio, NA, NA, NA, NA, NA, NA, 0, -1),
	[77] = PINGROUP(77, aud_intfc2_clk, phase_flag6, NA, qdss_gpio8, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[78] = PINGROUP(78, aud_intfc2_ws, phase_flag5, NA, qdss_gpio9, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[79] = PINGROUP(79, aud_intfc2_data0, phase_flag4, NA, qdss_gpio10, NA,
			NA, NA, NA, NA, NA, NA, 0, -1),
	[80] = PINGROUP(80, aud_intfc2_data1, phase_flag3, NA, NA, qdss_gpio11,
			NA, NA, NA, NA, NA, NA, 0, -1),
	[81] = PINGROUP(81, aud_intfc2_data2, aud_intfc10_data0, phase_flag2,
			NA, NA, qdss_gpio12, NA, NA, NA, NA, NA, 0, -1),
	[82] = PINGROUP(82, aud_intfc2_data3, aud_intfc10_data1, phase_flag1,
			NA, qdss_gpio13, NA, NA, NA, NA, NA, NA, 0, -1),
	[83] = PINGROUP(83, aud_intfc3_clk, dp_rx0, phase_flag28, NA,
			qdss_gpio14, NA, NA, NA, NA, NA, NA, 0, -1),
	[84] = PINGROUP(84, aud_intfc3_ws, dp_rx0, phase_flag29, NA,
			qdss_gpio15, NA, NA, NA, NA, NA, NA, 0, -1),
	[85] = PINGROUP(85, aud_intfc3_data0, dp_rx0, phase_flag30, NA,
			qdss_gpio0, NA, NA, NA, NA, NA, NA, 0, -1),
	[86] = PINGROUP(86, aud_intfc3_data1, aud_mclk0_mirb, dp_rx0,
			phase_flag31, NA, qdss_gpio1, NA, NA, NA, NA, NA, 0,
			-1),
	[87] = PINGROUP(87, aud_intfc4_clk, phase_flag7, NA, qdss_gpio2, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[88] = PINGROUP(88, aud_intfc4_ws, dp_rx0, phase_flag8, NA, qdss_gpio3,
			NA, NA, NA, NA, NA, NA, 0, -1),
	[89] = PINGROUP(89, aud_intfc4_data0, dp_rx0, phase_flag9, NA,
			qdss_gpio4, NA, NA, NA, NA, NA, NA, 0, -1),
	[90] = PINGROUP(90, aud_intfc4_data1, aud_mclk1_mirb, phase_flag10, NA,
			qdss_gpio5, NA, NA, NA, NA, NA, NA, 0, -1),
	[91] = PINGROUP(91, aud_intfc5_clk, phase_flag11, NA, qdss_gpio6, NA,
			NA, NA, NA, NA, NA, NA, 0, -1),
	[92] = PINGROUP(92, aud_intfc5_ws, phase_flag12, NA, qdss_gpio7, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[93] = PINGROUP(93, aud_intfc5_data0, phase_flag13, NA, qdss_gpio, NA,
			NA, NA, NA, NA, NA, NA, 0, -1),
	[94] = PINGROUP(94, aud_intfc5_data1, aud_mclk2_mirb, phase_flag14,
			tmess_prng0, NA, qdss_gpio8, NA, NA, NA, NA, NA, 0, -1),
	[95] = PINGROUP(95, aud_intfc6_clk, phase_flag15, tmess_prng1, NA,
			qdss_gpio9, NA, NA, NA, NA, NA, NA, 0, -1),
	[96] = PINGROUP(96, aud_intfc6_ws, phase_flag16, NA, qdss_gpio10, NA,
			NA, NA, NA, NA, NA, NA, 0, -1),
	[97] = PINGROUP(97, aud_intfc6_data0, qdss_gpio11, NA, NA, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[98] = PINGROUP(98, aud_intfc6_data1, phase_flag0, NA, qdss_gpio12, NA,
			NA, NA, NA, NA, NA, NA, 0, -1),
	[99] = PINGROUP(99, aud_mclk0_mira, qdss_gpio13, dp_rx00, ddr_pxi0, NA,
			NA, NA, NA, NA, NA, NA, 0, -1),
	[100] = PINGROUP(100, aud_mclk1_mira, aud_refclk0, pll_clk_aux,
			 qdss_gpio14, dp_rx01, ddr_pxi0, NA, NA, NA, NA, NA, 0,
			 -1),
	[101] = PINGROUP(101, aud_mclk2_mira, aud_refclk1, phase_flag17, NA,
			 qdss_gpio15, NA, NA, NA, NA, NA, NA, 0, -1),
	[102] = PINGROUP(102, qspi0, qup3_se0_l0_mira, qup3_se0_l1_mirb, NA, NA,
			 NA, NA, NA, NA, NA, NA, 0, -1),
	[103] = PINGROUP(103, qspi1, qup3_se0_l1_mira, qup3_se0_l0_mirb, NA, NA,
			 NA, NA, NA, NA, NA, NA, 0, -1),
	[104] = PINGROUP(104, qspi_clk, qup3_se0_l2, NA, NA, NA, NA, NA, NA, NA,
			 NA, NA, 0, -1),
	[105] = PINGROUP(105, qspi_cs0_n, qup3_se0_l3, gcc_gp5_clk, NA, NA, NA,
			 NA, NA, NA, NA, NA, 0, -1),
	[106] = PINGROUP(106, qspi2, qup3_se0_l4, gcc_gp6_clk, NA, NA, NA, NA,
			 NA, NA, NA, NA, 0, -1),
	[107] = PINGROUP(107, qspi3, qup3_se0_l5, NA, NA, NA, NA, NA, NA, NA,
			 NA, NA, 0, -1),
	[108] = PINGROUP(108, qspi_cs1_n, qup3_se0_l6, NA, NA, NA, NA, NA, NA,
			 NA, NA, NA, 0, -1),
	[109] = PINGROUP(109, qup0_se0_l2, qup0_se1_l2, qup0_se5_l2,
			 mdp_vsync_e, smb_alert_n, NA, ddr_pxi1, NA, NA, NA, NA,
			 0, -1),
	[110] = PINGROUP(110, qup0_se0_l3, qup0_se1_l3, qup0_se5_l3, qdss_cti,
			 mdp_vsync_p, smb_alert, NA, ddr_pxi1, NA, NA, NA, 0,
			 -1),
	[111] = PINGROUP(111, qup0_se1_l0, qup0_se0_l0, smb_dat, NA, NA, NA, NA,
			 NA, NA, NA, NA, 0, -1),
	[112] = PINGROUP(112, qup0_se1_l1, qup0_se0_l1, smb_clk, NA, NA, NA, NA,
			 NA, NA, NA, NA, 0, -1),
	[113] = PINGROUP(113, qup0_se2_l0, qup0_se3_l2, ccu_i2c_sda5,
			 mdp0_vsync0_out, dbg_out, ddr_pxi2, NA, NA, NA, NA, NA,
			 0, -1),
	[114] = PINGROUP(114, qup0_se2_l1, qup0_se3_l3, ccu_i2c_scl5,
			 mdp0_vsync1_out, NA, ddr_pxi2, NA, NA, NA, NA, NA, 0,
			 -1),
	[115] = PINGROUP(115, qup0_se3_l0, qup0_se2_l2, ccu_i2c_sda6,
			 mdp0_vsync2_out, NA, ddr_pxi3, NA, NA, NA, NA, NA, 0,
			 -1),
	[116] = PINGROUP(116, qup0_se3_l1, qup0_se2_l3, ccu_i2c_scl6,
			 mdp0_vsync3_out, NA, ddr_pxi3, NA, NA, NA, NA, NA, 0,
			 -1),
	[117] = PINGROUP(117, qup0_se4_l0, prng_rosc0, NA, ddr_pxi4, NA, NA, NA,
			 NA, NA, NA, NA, 0, -1),
	[118] = PINGROUP(118, qup0_se4_l1, prng_rosc1, NA, ddr_pxi4, NA, NA, NA,
			 NA, NA, NA, NA, 0, -1),
	[119] = PINGROUP(119, qup0_se4_l2, NA, ddr_pxi6, NA, NA, NA, NA, NA, NA,
			 NA, NA, 0, -1),
	[120] = PINGROUP(120, qup0_se4_l3, NA, ddr_pxi6, NA, NA, NA, NA, NA, NA,
			 NA, NA, 0, -1),
	[121] = PINGROUP(121, qup0_se5_l0, lbist_pass, mdp0_vsync4_out, NA,
			 ddr_pxi7, NA, NA, NA, NA, NA, NA, 0, -1),
	[122] = PINGROUP(122, qup0_se5_l1, mbist_pass, mdp0_vsync5_out, NA,
			 ddr_pxi7, NA, NA, NA, NA, NA, NA, 0, -1),
	[123] = PINGROUP(123, qup1_se0_l0, qup1_se1_l2, mdp1_vsync0_out,
			 jitter_bist, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[124] = PINGROUP(124, qup1_se0_l1, qup1_se1_l3, mdp1_vsync1_out, NA, NA,
			 NA, NA, NA, NA, NA, NA, 0, -1),
	...
	[126] = PINGROUP(126, qup1_se1_l1, qup1_se0_l3, ccu_i2c_scl7,
			 mdp1_vsync3_out, NA, atest_usb20, NA, NA, NA, NA, NA,
			 0, -1),
	[127] = PINGROUP(127, qup1_se2_l2, qup1_se2_l0, NA, atest_usb21, NA, NA,
			 NA, NA, NA, NA, NA, 0, -1),
	[128] = PINGROUP(128, qup1_se2_l3, qup1_se2_l1, NA, atest_usb20, NA, NA,
			 NA, NA, NA, NA, NA, 0, -1),
	[129] = PINGROUP(129, qup1_se3_l2, qup1_se3_l0, ccu_i2c_sda8,
			 mdp1_vsync4_out, NA, atest_usb21, NA, NA, NA, NA, NA,
			 0, -1),
	[130] = PINGROUP(130, qup1_se3_l3, qup1_se3_l1, ccu_i2c_scl8,
			 mdp1_vsync5_out, NA, atest_usb20, NA, NA, NA, NA, NA,
			 0, -1),
	[131] = PINGROUP(131, qup1_se4_l0, qup1_se6_l2, ccu_i2c_sda9,
			 mdp1_vsync6_out, NA, atest_usb21, NA, NA, NA, NA, NA,
			 0, -1),
	[132] = PINGROUP(132, qup1_se4_l1, qup1_se6_l3, ccu_i2c_scl9,
			 mdp1_vsync7_out, NA, vsense_trigger_mirnat, NA, NA, NA,
			 NA, NA, 0, -1),
	[133] = PINGROUP(133, qup1_se5_l0, emac0_ptp, mdp1_vsync8_out, NA, NA,
			 NA, NA, NA, NA, NA, NA, 0, -1),
	[134] = PINGROUP(134, qup1_se5_l1, emac0_ptp, mdp1_vsync9_out, NA, NA,
			 NA, NA, NA, NA, NA, NA, 0, -1),
	[135] = PINGROUP(135, qup1_se5_l2, emac0_ptp, mdp1_vsync10_out, NA, NA,
			 NA, NA, NA, NA, NA, NA, 0, -1),
	[136] = PINGROUP(136, qup1_se5_l3, emac0_ptp, NA, NA, NA, NA, NA, NA,
			 NA, NA, NA, 0, -1),
	[137] = PINGROUP(137, qup1_se6_l0, qup1_se4_l2, dp_rx0, NA, NA, NA, NA,
			 NA, NA, NA, NA, 0, -1),
	[138] = PINGROUP(138, qup1_se6_l1, qup1_se4_l3, dp_rx0, qdss_cti,
			 jitter_bist, NA, NA, NA, NA, NA, NA, 0, -1),
	[139] = PINGROUP(139, qup2_se0_l0, emac0_ptp, mdp0_vsync6_out, NA, NA,
			 NA, NA, NA, NA, NA, NA, 0, -1),
	[140] = PINGROUP(140, qup2_se0_l1, emac0_ptp, mdp0_vsync7_out, NA, NA,
			 NA, NA, NA, NA, NA, NA, 0, -1),
	[141] = PINGROUP(141, qup2_se0_l2, emac0_ptp, mdp0_vsync8_out, NA, NA,
			 NA, NA, NA, NA, NA, NA, 0, -1),
	[142] = PINGROUP(142, qup2_se0_l3, emac0_ptp, qdss_cti, mdp0_vsync9_out,
			 NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[143] = PINGROUP(143, qup2_se1_l2, qup2_se4_l2, ccu_timer10,
			 mdp0_vsync10_out, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[144] = PINGROUP(144, qup2_se1_l3, qup2_se4_l3, ccu_timer11, qdss_cti,
			 mdp_vsync_s, NA, NA, NA, NA, NA, NA, 0, -1),
	[145] = PINGROUP(145, qup2_se2_l0, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, 0, -1),
	[146] = PINGROUP(146, qup2_se2_l1, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, 0, -1),
	[147] = PINGROUP(147, qup2_se2_l2, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, 0, -1),
	[148] = PINGROUP(148, qup2_se2_l3, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, 0, -1),
	[149] = PINGROUP(149, qup2_se2_l4, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, 0, -1),
	[150] = PINGROUP(150, qup2_se3_l0, qup2_se4_l4, ccu_timer12, NA, NA, NA,
			 NA, NA, NA, NA, NA, 0, -1),
	[151] = PINGROUP(151, qup2_se3_l1, qup2_se4_l5, ccu_timer13, NA, NA, NA,
			 NA, NA, NA, NA, NA, 0, -1),
	[152] = PINGROUP(152, qup2_se3_l2, qup2_se4_l6, ccu_timer14, NA, NA, NA,
			 NA, NA, NA, NA, NA, 0, -1),
	[153] = PINGROUP(153, qup2_se3_l3, ccu_timer15, NA, NA, NA, NA, NA, NA,
			 NA, NA, NA, 0, -1),
	[154] = PINGROUP(154, qup2_se4_l0, qup2_se1_l0, NA, NA, NA, NA, NA, NA,
			 NA, NA, NA, 0, -1),
	[155] = PINGROUP(155, qup2_se4_l1, qup2_se1_l1, NA, NA, NA, NA, NA, NA,
			 NA, NA, NA, 0, -1),
	[156] = PINGROUP(156, qup2_se5_l0, qup2_se6_l2, NA, NA, NA, NA, NA, NA,
			 NA, NA, NA, 0, -1),
	[157] = PINGROUP(157, qup2_se5_l1, qup2_se6_l3, NA, NA, NA, NA, NA, NA,
			 NA, NA, NA, 0, -1),
	[158] = PINGROUP(158, qup2_se6_l0, qup2_se5_l2, NA, NA, NA, NA, NA, NA,
			 NA, NA, NA, 0, -1),
	[159] = PINGROUP(159, qup2_se6_l1, qup2_se5_l3, NA, NA, NA, NA, NA, NA,
			 NA, NA, NA, 0, -1),
	[160] = PINGROUP(160, wcn_sw_ctrl, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, 0, -1),
	[161] = PINGROUP(161, wcn_sw, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0,
			 -1),
	[162] = PINGROUP(162, qdss_cti, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[163] = PINGROUP(163, qdss_cti, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[164] = PINGROUP(164, usb0_phy_ps, NA, sailss_ospi, ddr_pxi5, NA, NA,
			 NA, NA, NA, NA, NA, 0, -1),
	[165] = PINGROUP(165, usb1_phy_ps, dbg_out_clk, sailss_ospi, ddr_pxi5,
			 NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[166] = PINGROUP(166, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0,
			 -1),
	[167] = PINGROUP(167, pwrbrk_i_n, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, 0, -1),
	[168] = PINGROUP(168, bist_done, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[169] = PINGROUP(169, tb_trig_sdc4, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, 0, -1),
	[170] = PINGROUP(170, sdc4_data, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[171] = PINGROUP(171, sdc4_data, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[172] = PINGROUP(172, sdc4_data, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[173] = PINGROUP(173, sdc4_data, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[174] = PINGROUP(174, sdc4_cmd, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[175] = PINGROUP(175, sdc4_clk, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[176] = PINGROUP(176, ccu_async_in0, pll_bist_sync, atest_char_start,
			 NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[177] = PINGROUP(177, ccu_async_in1, atest_char0, NA, NA, NA, NA, NA,
			 NA, NA, NA, NA, 0, -1),
	[178] = PINGROUP(178, ccu_async_in2, atest_char1, NA, NA, NA, NA, NA,
			 NA, NA, NA, NA, 0, -1),
	[179] = PINGROUP(179, ccu_async_in3, atest_char2, NA, NA, NA, NA, NA,
			 NA, NA, NA, NA, 0, -1),
	[180] = PINGROUP(180, ccu_async_in4, atest_char3, NA, NA, NA, NA, NA,
			 NA, NA, NA, NA, 0, -1),
	[181] = UFS_RESET(ufs_reset, 0x1BD004),
	[182] = UFS_RESET(ufs1_reset, 0x1BF004),
};

static const struct msm_gpio_wakeirq_map seca_pdc_map[] = {
...
static const struct msm_pinctrl_soc_data seca_tlmm = {
	...
	.functions = seca_functions,
	.nfunctions = ARRAY_SIZE(seca_functions),
	.groups = seca_groups,
	.ngroups = ARRAY_SIZE(seca_groups),
	.ngpios = 183,
...
static const struct of_device_id seca_tlmm_of_match[] = {
	{ .compatible = "qcom,seca-tlmm", .data = &seca_tlmm },
	{},
};

static int seca_tlmm_probe(struct platform_device *pdev)
{
...
static int __init seca_tlmm_init(void)
{
	return platform_driver_register(&seca_tlmm_driver);
}
arch_initcall(seca_tlmm_init);

static void __exit seca_tlmm_exit(void)
{
	platform_driver_unregister(&seca_tlmm_driver);
}
module_exit(seca_tlmm_exit);

MODULE_DESCRIPTION("QTI seca TLMM driver");
MODULE_LICENSE("GPL");
MODULE_DEVICE_TABLE(of, seca_tlmm_of_match);
