...
static const struct pinfunction  ravelin_functions[] = {
	FUNCTION(gpio),
...
static const struct msm_pingroup ravelin_groups[] = {
	...
	[21] = PINGROUP(21, qup0_se3_l3, NA, phase_flag_status12,
			tgu_ch1_trigout, NA, NA, NA, NA, NA, NA, NA, 0x88004, 2),
	[22] = PINGROUP(22, qup1_se2_l2, mdp_vsync_s, mdp_vsync2_out,
			mdp_vsync3_out, tgu_ch2_trigout, NA, NA, NA, NA, NA, NA, 0x88004, 3),
	[23] = PINGROUP(23, qup1_se2_l3, tgu_ch3_trigout, qdss_gpio_tracedata2,
			NA, NA, NA, NA, NA, NA, NA, NA, 0x88004, 4),
	[24] = PINGROUP(24, qup1_se3_l0, NA, phase_flag_status13, NA, NA, NA,
			NA, NA, NA, NA, NA, 0x88004, 5),
	[25] = PINGROUP(25, qup1_se3_l1, NA, phase_flag_status14, NA, NA, NA,
			NA, NA, NA, NA, NA, 0x88004, 6),
	[26] = PINGROUP(26, qup1_se1_l2, mdp_vsync_e, qup0_se4_l0,
			qdss_cti_trig0, NA, NA, NA, NA, NA, NA, NA, 0x88004, 7),
	[27] = PINGROUP(27, qup1_se1_l3, qup0_se4_l1, qdss_cti_trig1, NA, NA,
			NA, NA, NA, NA, NA, NA, 0x88004, 8),
	[28] = PINGROUP(28, cmu_rng_entropy0, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88018, 0),
	[29] = PINGROUP(29, ddr_bist_fail, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[30] = PINGROUP(30, mdp_vsync_s, gcc_gp2_clk, ddr_bist_start, NA, NA,
			NA, NA, NA, NA, NA, NA, 0x88018, 1),
	[31] = PINGROUP(31, qup1_se2_l0, NA, phase_flag_status0, ddr_bist_stop,
			qdss_gpio_tracedata4, NA, NA, NA, NA, NA, NA, 0x88004, 9),
	...
	[33] = PINGROUP(33, NA, phase_flag_status15, qdss_gpio_tracedata7, NA,
			NA, NA, NA, NA, NA, NA, NA, 0x88004, 10),
	[34] = PINGROUP(34, qup0_se0_l2, qup0_se4_l4, mdp_vsync_e, NA, NA, NA,
			NA, NA, NA, NA, NA, 0x88004, 11),
	[35] = PINGROUP(35, qup0_se0_l3, NA, phase_flag_status16,
			qdss_gpio_tracedata8, NA, NA, NA, NA, NA, NA, NA, 0x88004, 12),
	...
	[37] = PINGROUP(37, cam_mclk, gcc_gp1_clk, prng_rosc_test0,
			qdss_gpio_tracedata5, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	...
	[47] = PINGROUP(47, cci_i2c_scl1, qdss_gpio_tracedata13, NA, NA, NA,
			NA, NA, NA, NA, NA, NA, 0x88010, 7),
	[48] = PINGROUP(48, cci_i2c_sda2, qup1_se4_l2, gcc_gp1_clk, NA, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[49] = PINGROUP(49, cci_i2c_scl2, qup1_se4_l4, gcc_gp2_clk,
			qdss_gpio_tracedata15, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[50] = PINGROUP(50, qup1_se1_l0, qup1_se3_l3, NA, gcc_gp3_clk, NA, NA,
			NA, NA, NA, NA, NA, 0x88004, 13),
	[51] = PINGROUP(51, qup1_se1_l1, qup1_se3_l2, NA, tb_trig_sdc2, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[52] = PINGROUP(52, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88018, 2),
	[53] = PINGROUP(53, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88004, 14),
	[54] = PINGROUP(54, coex_uart1_rx, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88018, 3),
	[55] = PINGROUP(55, coex_uart1_tx, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88018, 4),
	[56] = PINGROUP(56, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88018, 5),
	[57] = PINGROUP(57, tmess_prng_rosc0, qdss_cti_trig1, NA, NA, NA, NA,
			NA, NA, NA, NA, NA, 0x88018, 6),
	[58] = PINGROUP(58, tmess_prng_rosc1, qdss_cti_trig1, NA, NA, NA, NA,
			NA, NA, NA, NA, NA, 0x88018, 7),
	[59] = PINGROUP(59, tmess_prng_rosc2, qdss_gpio_tracedata6, NA, NA, NA,
			NA, NA, NA, NA, NA, NA, 0x88004, 15),
	[60] = PINGROUP(60, tmess_prng_rosc3, qdss_cti_trig0, NA, NA, NA, NA,
			NA, NA, NA, NA, NA, 0x88018, 8),
	[61] = PINGROUP(61, NA, phase_flag_status18, NA, NA, NA, NA, NA, NA,
			NA, NA, NA, 0x88008, 0),
	[62] = PINGROUP(62, qdss_gpio_tracedata9, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, NA, 0x88008, 1),
	[63] = PINGROUP(63, uim0_data, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[64] = PINGROUP(64, uim0_clk, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[65] = PINGROUP(65, uim0_reset, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[66] = PINGROUP(66, uim0_present, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88008, 2),
	[67] = PINGROUP(67, uim1_data, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88008, 3),
	[68] = PINGROUP(68, uim1_clk, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[69] = PINGROUP(69, uim1_reset, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[70] = PINGROUP(70, uim1_present, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88008, 4),
	[71] = PINGROUP(71, NA, NA, NA, audio_ref_clk, NA, NA, NA, NA, NA, NA, NA, 0x88008, 5),
	[72] = PINGROUP(72, NA, NA, NA, phase_flag_status22, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[73] = PINGROUP(73, NA, NA, NA, pll_bist_sync, NA, NA, NA, NA, NA, NA, NA, 0x88008, 6),
	[74] = PINGROUP(74, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[75] = PINGROUP(75, NA, NA, NA, vsense_trigger_mirnat,
			atest_usb0_atereset, NA, NA, NA, NA, NA, NA, 0x88008, 7),
	[76] = PINGROUP(76, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[77] = PINGROUP(77, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88008, 8),
	[78] = PINGROUP(78, NA, NA, NA, atest_usb0_testdataout01, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[79] = PINGROUP(79, NA, NA, NA, wlan1_adc_dtest0,
			atest_usb0_testdataout02, NA, NA, NA, NA, NA, NA, 0x88008, 9),
	[80] = PINGROUP(80, NA, NA, dbg_out_clk, wlan1_adc_dtest1,
			atest_usb0_testdataout03, NA, NA, NA, NA, NA, NA, 0, -1),
	[81] = PINGROUP(81, NA, nav_gpio2, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88018, 9),
	[82] = PINGROUP(82, NA, NA, phase_flag_status19, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[83] = PINGROUP(83, nav_gpio0, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88018, 10),
	[84] = PINGROUP(84, nav_gpio1, vfr_1, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88018, 11),
	[85] = PINGROUP(85, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[86] = PINGROUP(86, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88018, 12),
	[87] = PINGROUP(87, qlink0_request, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88018, 13),
	[88] = PINGROUP(88, qlink0_enable, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[89] = PINGROUP(89, qlink0_wmss_reset, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[90] = PINGROUP(90, qup1_se4_l1, jitter_bist_ref, ddr_pxi0_test, NA,
			NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[91] = PINGROUP(91, qup1_se4_l0, NA, phase_flag_status20, NA, NA, NA,
			NA, NA, NA, NA, NA, 0x88010, 8),
	[92] = PINGROUP(92, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88008, 10),
	[93] = PINGROUP(93, mdp_vsync_p, mdp_vsync0_out, mdp_vsync1_out, NA,
			NA, NA, NA, NA, NA, NA, NA, 0x88008, 11),
	[94] = PINGROUP(94, usb0_phy_ps, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88008, 12),
	[95] = PINGROUP(95, NA, phase_flag_status23, atest_char_start, NA, NA,
			NA, NA, NA, NA, NA, NA, 0x88008, 13),
	[96] = PINGROUP(96, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88018, 14),
	[97] = PINGROUP(97, mdp_vsync_p, NA, phase_flag_status24,
			atest_char_status0, NA, NA, NA, NA, NA, NA, NA, 0x88008, 14),
	[98] = PINGROUP(98, NA, phase_flag_status25, atest_char_status1, NA,
			NA, NA, NA, NA, NA, NA, NA, 0x88008, 15),
	[99] = PINGROUP(99, usb0_hs_ac, NA, phase_flag_status26,
			atest_char_status2, NA, NA, NA, NA, NA, NA, NA, 0x8800C, 0),
	[100] = PINGROUP(100, vfr_0_mirb, NA, phase_flag_status27,
			 atest_char_status3, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[101] = PINGROUP(101, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x8800C, 1),
	[102] = PINGROUP(102, sd_write_protect, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x8800C, 2),
	[103] = PINGROUP(103, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x8800C, 3),
	[104] = PINGROUP(104, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[105] = PINGROUP(105, NA, phase_flag_status28, NA, NA, NA, NA, NA, NA,
			 NA, NA, NA, 0x8800C, 4),
	[106] = PINGROUP(106, host2wlan_sol, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[107] = PINGROUP(107, pcie0_clk_req, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88018, 15),
	[108] = PINGROUP(108, pll_clk_aux, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[109] = PINGROUP(109, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[110] = PINGROUP(110, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0x88010, 9),
	[111] = PINGROUP(111, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[112] = PINGROUP(112, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[113] = PINGROUP(113, qdss_cti_trig0, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0x88010, 10),
	[114] = PINGROUP(114, qdss_cti_trig0, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0x88010, 11),
	...
	[118] = PINGROUP(118, qdss_gpio_tracedata14, NA, ddr_pxi1_test, NA, NA,
			 NA, NA, NA, NA, NA, egpio, 0x88010, 12),
	[119] = PINGROUP(119, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[120] = PINGROUP(120, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0x88010, 13),
	[121] = PINGROUP(121, qdss_gpio_tracedata2, NA, NA, NA, NA, NA, NA, NA,
			 NA, NA, egpio, 0x88010, 14),
	[122] = PINGROUP(122, qdss_gpio_tracedata3, NA, ddr_pxi1_test, NA, NA,
			 NA, NA, NA, NA, NA, egpio, 0, -1),
	[123] = PINGROUP(123, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0x88010, 15),
	[124] = PINGROUP(124, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[125] = PINGROUP(125, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0x88014, 0),
	[126] = PINGROUP(126, qdss_gpio_tracedata0, NA, NA, NA, NA, NA, NA, NA,
			 NA, NA, egpio, 0, -1),
	[127] = PINGROUP(127, qdss_gpio_tracedata1, ddr_pxi0_test, NA, NA, NA,
			 NA, NA, NA, NA, NA, egpio, 0, -1),
	[128] = PINGROUP(128, tb_trig_sdc1, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0x88014, 1),
	[129] = PINGROUP(129, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[130] = PINGROUP(130, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0x88014, 2),
	[131] = PINGROUP(131, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[132] = PINGROUP(132, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[133] = PINGROUP(133, NA, phase_flag_status21, NA, NA, NA, NA, NA, NA,
			 NA, NA, egpio, 0x88014, 3),
