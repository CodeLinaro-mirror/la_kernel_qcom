...
#define QUP_0_I3C_0_MODE_OFFSET 0x9F000
#define QUP_1_I3C_0_MODE_OFFSET 0xA0000

static const struct pinctrl_pin_desc bourtzi_pins[] = {
...
static const char *const mdp_vsync_groups[] = {
	"gpio22", "gpio26", "gpio30", "gpio34", "gpio93", "gpio97",
};
...
static const char *const qdss_cti_groups[] = {
	"gpio6", "gpio26", "gpio27", "gpio57", "gpio58", "gpio60",
	"gpio113", "gpio114",
};

static const char *const qdss_gpio_groups[] = {
	"gpio4", "gpio5", "gpio40", "gpio41",
};
...
static const struct pinfunction bourtzi_functions[] = {
	...
	MSM_PIN_FUNCTION(qup0_se4_l0_mira),
	MSM_PIN_FUNCTION(qup0_se4_l0_mirb),
	MSM_PIN_FUNCTION(qup0_se4_l1_mira),
	MSM_PIN_FUNCTION(qup0_se4_l1_mirb),
 ...
 */
static const struct msm_pingroup bourtzi_groups[] = {
	[0] = PINGROUP(0, qup1_se0_l0, ibi_i3c, cmu_rng3, qdss_gpio0, NA, NA,
		       NA, NA, NA, NA, NA, 0x88000, 3),
	[1] = PINGROUP(1, qup1_se0_l1, ibi_i3c, cmu_rng2, qdss_gpio1, NA, NA,
		       NA, NA, NA, NA, NA, 0, -1),
	[2] = PINGROUP(2, qup1_se0_l2, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
		       0, -1),
	[3] = PINGROUP(3, qup1_se0_l3, gcc_gp3, cmu_rng1, qdss_gpio3, NA, NA,
		       NA, NA, NA, NA, NA, 0x88000, 4),
	[4] = PINGROUP(4, qup0_se0_l0, ibi_i3c, qdss_gpio, NA, NA, NA, NA, NA,
		       NA, NA, NA, 0x88000, 5),
	[5] = PINGROUP(5, qup0_se0_l1, ibi_i3c, qdss_gpio, NA, NA, NA, NA, NA,
		       NA, NA, NA, 0x88000, 6),
	[6] = PINGROUP(6, qup0_se4_l2, uim1_data_mirb, qdss_cti, NA, NA, NA, NA,
		       NA, NA, NA, NA, 0x88000, 7),
	[7] = PINGROUP(7, qup0_se4_l3, uim1_clk_mirb, NA, phase_flag2,
		       qdss_gpio10, NA, NA, NA, NA, NA, NA, 0x88000, 8),
	[8] = PINGROUP(8, qup0_se4_l0_mira, uim1_reset_mirb, NA, phase_flag3,
		       qdss_gpio11, NA, NA, NA, NA, NA, NA, 0x88000, 9),
	[9] = PINGROUP(9, qup0_se4_l1_mira, uim1_present_mirb, NA, phase_flag4,
		       qdss_gpio12, NA, NA, NA, NA, NA, NA, 0x88000, 10),
	[10] = PINGROUP(10, qup0_se1_l0, NA, atest_usb00, NA, NA, NA, NA, NA,
			NA, NA, NA, 0x88000, 11),
	[11] = PINGROUP(11, qup0_se1_l1, NA, phase_flag5, NA, NA, NA, NA, NA,
			NA, NA, NA, 0x88000, 12),
	[12] = PINGROUP(12, qup0_se1_l2, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0x88000, 13),
	[13] = PINGROUP(13, qup0_se1_l3, NA, phase_flag6, NA, NA, NA, NA, NA,
			NA, NA, NA, 0x88000, 14),
	[14] = PINGROUP(14, qup0_se2_l0, NA, phase_flag7, NA, qdss_gpio13, NA,
			NA, NA, NA, NA, NA, 0x88000, 15),
	[15] = PINGROUP(15, qup0_se2_l1, NA, phase_flag8, NA, qdss_gpio14, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[16] = PINGROUP(16, qup0_se2_l2, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[17] = PINGROUP(17, qup0_se2_l3, NA, phase_flag9, NA, qdss_gpio15, NA,
			NA, NA, NA, NA, NA, 0x88004, 0),
	[18] = PINGROUP(18, qup0_se3_l0, NA, phase_flag10, NA, NA, NA, NA, NA,
			NA, NA, NA, 0x88004, 1),
	[19] = PINGROUP(19, qup0_se3_l1, vfr_0_mira, NA, phase_flag11, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[20] = PINGROUP(20, qup0_se3_l2, tgu_ch0_trigout, NA, NA, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[21] = PINGROUP(21, qup0_se3_l3, NA, phase_flag12, tgu_ch1_trigout, NA,
			NA, NA, NA, NA, NA, NA, 0x88004, 2),
	[22] = PINGROUP(22, qup1_se2_l2, mdp_vsync, mdp_vsync2_out,
			mdp_vsync3_out, tgu_ch2_trigout, NA, NA, NA, NA, NA, NA,
			0x88004, 3),
	[23] = PINGROUP(23, qup1_se2_l3, tgu_ch3_trigout, qdss_gpio2, NA, NA,
			NA, NA, NA, NA, NA, NA, 0x88004, 4),
	[24] = PINGROUP(24, qup1_se3_l0, NA, phase_flag13, NA, NA, NA, NA, NA,
			NA, NA, NA, 0x88004, 5),
	[25] = PINGROUP(25, qup1_se3_l1, NA, phase_flag14, NA, NA, NA, NA, NA,
			NA, NA, NA, 0x88004, 6),
	[26] = PINGROUP(26, qup1_se1_l2, mdp_vsync, qup0_se4_l0_mirb, qdss_cti,
			NA, NA, NA, NA, NA, NA, NA, 0x88004, 7),
	[27] = PINGROUP(27, qup1_se1_l3, qup0_se4_l1_mirb, qdss_cti, NA, NA, NA,
			NA, NA, NA, NA, NA, 0x88004, 8),
	[28] = PINGROUP(28, cmu_rng0, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0x88018, 0),
	[29] = PINGROUP(29, ddr_bist_fail, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, 0, -1),
	[30] = PINGROUP(30, mdp_vsync, gcc_gp2, ddr_bist_start, NA, NA, NA, NA,
			NA, NA, NA, NA, 0x88018, 1),
	[31] = PINGROUP(31, qup1_se2_l0, NA, phase_flag0, ddr_bist_stop,
			qdss_gpio4, NA, NA, NA, NA, NA, NA, 0x88004, 9),
	[32] = PINGROUP(32, qup1_se2_l1, NA, phase_flag1, ddr_bist_complete,
			qdss_gpio5, NA, NA, NA, NA, NA, NA, 0, -1),
	[33] = PINGROUP(33, NA, phase_flag15, qdss_gpio7, NA, NA, NA, NA, NA,
			NA, NA, NA, 0x88004, 10),
	[34] = PINGROUP(34, qup0_se0_l2, qup0_se4_l4, mdp_vsync, NA, NA, NA, NA,
			NA, NA, NA, NA, 0x88004, 11),
	[35] = PINGROUP(35, qup0_se0_l3, NA, phase_flag16, qdss_gpio8, NA, NA,
			NA, NA, NA, NA, NA, 0x88004, 12),
	[36] = PINGROUP(36, cam_mclk, prng_rosc3, qdss_gpio4, NA, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[37] = PINGROUP(37, cam_mclk, gcc_gp1, prng_rosc0, qdss_gpio5, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[38] = PINGROUP(38, cam_mclk, prng_rosc1, qdss_gpio6, NA, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[39] = PINGROUP(39, cam_mclk, prng_rosc2, qdss_gpio7, NA, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[40] = PINGROUP(40, cci_timer0, cci_async_in0, cri_trng0, qdss_gpio, NA,
			NA, NA, NA, NA, NA, NA, 0x88010, 3),
	[41] = PINGROUP(41, cci_timer1, cri_trng1, qdss_gpio, NA, NA, NA, NA,
			NA, NA, NA, NA, 0x88010, 4),
	[42] = PINGROUP(42, cci_timer2, cri_trng, qdss_gpio8, NA, NA, NA, NA,
			NA, NA, NA, NA, 0x88010, 5),
	[43] = PINGROUP(43, cci_timer3, qup1_se4_l3, qdss_gpio9, NA, NA, NA, NA,
			NA, NA, NA, NA, 0x88010, 6),
	[44] = PINGROUP(44, cci_i2c_sda0, qdss_gpio10, NA, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[45] = PINGROUP(45, cci_i2c_scl0, qdss_gpio11, NA, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[46] = PINGROUP(46, cci_i2c_sda1, qdss_gpio12, NA, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[47] = PINGROUP(47, cci_i2c_scl1, qdss_gpio13, NA, NA, NA, NA, NA, NA,
			NA, NA, NA, 0x88010, 7),
	[48] = PINGROUP(48, cci_i2c_sda2, qup1_se4_l2, gcc_gp1, NA, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[49] = PINGROUP(49, cci_i2c_scl2, qup1_se4_l4, gcc_gp2, qdss_gpio15, NA,
			NA, NA, NA, NA, NA, NA, 0, -1),
	[50] = PINGROUP(50, qup1_se1_l0, qup1_se3_l3, NA, gcc_gp3, NA, NA, NA,
			NA, NA, NA, NA, 0x88004, 13),
	[51] = PINGROUP(51, qup1_se1_l1, qup1_se3_l2, NA, tb_trig_sdc2, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[52] = PINGROUP(52, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88018,
			2),
	[53] = PINGROUP(53, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88004,
			14),
	[54] = PINGROUP(54, coex_uart1_rx, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, 0x88018, 3),
	[55] = PINGROUP(55, coex_uart1_tx, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, 0x88018, 4),
	[56] = PINGROUP(56, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88018,
			5),
	[57] = PINGROUP(57, tmess_prng0, qdss_cti, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0x88018, 6),
	[58] = PINGROUP(58, tmess_prng1, qdss_cti, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0x88018, 7),
	[59] = PINGROUP(59, tmess_prng2, qdss_gpio6, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0x88004, 15),
	[60] = PINGROUP(60, tmess_prng3, qdss_cti, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0x88018, 8),
	[61] = PINGROUP(61, NA, phase_flag18, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, 0x88008, 0),
	[62] = PINGROUP(62, qdss_gpio9, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0x88008, 1),
	[63] = PINGROUP(63, uim0_data, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[64] = PINGROUP(64, uim0_clk, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0,
			-1),
	[65] = PINGROUP(65, uim0_reset, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[66] = PINGROUP(66, uim0_present, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, 0x88008, 2),
	[67] = PINGROUP(67, uim1_data_mira, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, 0x88008, 3),
	[68] = PINGROUP(68, uim1_clk_mira, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, 0, -1),
	[69] = PINGROUP(69, uim1_reset_mira, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, 0, -1),
	[70] = PINGROUP(70, uim1_present_mira, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0x88008, 4),
	[71] = PINGROUP(71, NA, NA, NA, audio_ref_clk, NA, NA, NA, NA, NA, NA,
			NA, 0x88008, 5),
	[72] = PINGROUP(72, NA, NA, NA, phase_flag22, NA, NA, NA, NA, NA, NA,
			NA, 0, -1),
	[73] = PINGROUP(73, NA, NA, NA, pll_bist_sync, NA, NA, NA, NA, NA, NA,
			NA, 0x88008, 6),
	[74] = PINGROUP(74, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[75] = PINGROUP(75, NA, NA, NA, vsense_trigger_mirnat, atest_usb0, NA,
			NA, NA, NA, NA, NA, 0x88008, 7),
	[76] = PINGROUP(76, NA, NA, NA, NA, wlan2_adc1, NA, NA, NA, NA, NA, NA,
			0, -1),
	[77] = PINGROUP(77, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88008,
			8),
	[78] = PINGROUP(78, NA, NA, NA, wlan2_adc0, atest_usb01, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[79] = PINGROUP(79, NA, NA, NA, wlan1_adc0, atest_usb02, NA, NA, NA, NA,
			NA, NA, 0x88008, 9),
	[80] = PINGROUP(80, NA, NA, dbg_out_clk, wlan1_adc1, atest_usb03, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[81] = PINGROUP(81, NA, nav_gpio2, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0x88018, 9),
	[82] = PINGROUP(82, NA, NA, phase_flag19, NA, NA, NA, NA, NA, NA, NA,
			NA, 0, -1),
	[83] = PINGROUP(83, nav_gpio0, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0x88018, 10),
	[84] = PINGROUP(84, nav_gpio1, vfr_1, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, 0x88018, 11),
	[85] = PINGROUP(85, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[86] = PINGROUP(86, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88018,
			12),
	[87] = PINGROUP(87, qlink0_request, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, 0x88018, 13),
	[88] = PINGROUP(88, qlink0_enable, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			NA, 0, -1),
	[89] = PINGROUP(89, qlink0_wmss, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[90] = PINGROUP(90, qup1_se4_l1, jitter_bist, ddr_pxi0, NA, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[91] = PINGROUP(91, qup1_se4_l0, NA, phase_flag20, NA, NA, NA, NA, NA,
			NA, NA, NA, 0x88010, 8),
	[92] = PINGROUP(92, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88008,
			10),
	[93] = PINGROUP(93, mdp_vsync, mdp_vsync0_out, mdp_vsync1_out, NA, NA,
			NA, NA, NA, NA, NA, NA, 0x88008, 11),
	[94] = PINGROUP(94, usb0_phy_ps, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0x88008, 12),
	[95] = PINGROUP(95, NA, phase_flag23, atest_char_start, NA, NA, NA, NA,
			NA, NA, NA, NA, 0x88008, 13),
	[96] = PINGROUP(96, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x88018,
			14),
	[97] = PINGROUP(97, mdp_vsync, NA, phase_flag24, atest_char0, NA, NA,
			NA, NA, NA, NA, NA, 0x88008, 14),
	[98] = PINGROUP(98, NA, phase_flag25, atest_char1, NA, NA, NA, NA, NA,
			NA, NA, NA, 0x88008, 15),
	[99] = PINGROUP(99, usb0_hs, NA, phase_flag26, atest_char2, NA, NA, NA,
			NA, NA, NA, NA, 0x8800C, 0),
	[100] = PINGROUP(100, vfr_0_mirb, NA, phase_flag27, atest_char3, NA, NA,
			 NA, NA, NA, NA, NA, 0, -1),
	[101] = PINGROUP(101, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0x8800C, 1),
	[102] = PINGROUP(102, sd_write_protect, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, NA, 0x8800C, 2),
	[103] = PINGROUP(103, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0x8800C, 3),
	[104] = PINGROUP(104, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0,
			 -1),
	[105] = PINGROUP(105, NA, phase_flag28, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, 0x8800C, 4),
	[106] = PINGROUP(106, host2wlan_sol, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, 0, -1),
	[107] = PINGROUP(107, pcie0_clk_req_n, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, NA, 0x88018, 15),
	[108] = PINGROUP(108, pll_clk_aux, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, 0, -1),
	[109] = PINGROUP(109, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0,
			 -1),
	[110] = PINGROUP(110, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0x88010, 9),
	[111] = PINGROUP(111, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0,
			 -1),
	[112] = PINGROUP(112, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0,
			 -1),
	[113] = PINGROUP(113, qdss_cti, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 egpio, 0x88010, 10),
	[114] = PINGROUP(114, qdss_cti, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 egpio, 0x88010, 11),
	[115] = PINGROUP(115, NA, phase_flag29, NA, NA, NA, NA, NA, NA, NA, NA,
			 egpio, 0, -1),
	[116] = PINGROUP(116, NA, phase_flag30, NA, NA, NA, NA, NA, NA, NA, NA,
			 egpio, 0, -1),
	[117] = PINGROUP(117, NA, phase_flag31, NA, NA, NA, NA, NA, NA, NA, NA,
			 egpio, 0, -1),
	[118] = PINGROUP(118, qdss_gpio14, NA, ddr_pxi1, NA, NA, NA, NA, NA, NA,
			 NA, egpio, 0x88010, 12),
	[119] = PINGROUP(119, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0,
			 -1),
	[120] = PINGROUP(120, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0x88010, 13),
	[121] = PINGROUP(121, qdss_gpio2, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 egpio, 0x88010, 14),
	[122] = PINGROUP(122, qdss_gpio3, NA, ddr_pxi1, NA, NA, NA, NA, NA, NA,
			 NA, egpio, 0, -1),
	[123] = PINGROUP(123, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0x88010, 15),
	[124] = PINGROUP(124, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0,
			 -1),
	[125] = PINGROUP(125, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0x88014, 0),
	[126] = PINGROUP(126, qdss_gpio0, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 egpio, 0, -1),
	[127] = PINGROUP(127, qdss_gpio1, ddr_pxi0, NA, NA, NA, NA, NA, NA, NA,
			 NA, egpio, 0, -1),
	[128] = PINGROUP(128, tb_trig_sdc1, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 egpio, 0x88014, 1),
	[129] = PINGROUP(129, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0,
			 -1),
	[130] = PINGROUP(130, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0x88014, 2),
	[131] = PINGROUP(131, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0,
			 -1),
	[132] = PINGROUP(132, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0,
			 -1),
	[133] = PINGROUP(133, NA, phase_flag21, NA, NA, NA, NA, NA, NA, NA, NA,
			 egpio, 0x88014, 3),
	[134] = PINGROUP(134, tsense_pwm1, tsense_pwm2, NA, NA, NA, NA, NA, NA,
			 NA, NA, egpio, 0, -1),
	[135] = PINGROUP(135, NA, phase_flag17, NA, NA, NA, NA, NA, NA, NA, NA,
			 egpio, 0x88014, 4),
...
static struct pinctrl_qup bourtzi_qup_regs[] = {
	QUP_I3C(1, QUP_0_I3C_0_MODE_OFFSET),
	QUP_I3C(2, QUP_1_I3C_0_MODE_OFFSET),
};

static const struct msm_gpio_wakeirq_map bourtzi_pdc_map[] = {
	{ 0, 67 }, { 3, 82 }, { 4, 69 }, { 5, 70 }, { 6, 44 }, { 7, 43 },
	{ 8, 71 }, { 9, 86 }, { 10, 48 }, { 11, 77 }, { 12, 90 }, { 13, 54 },
	{ 14, 91 }, { 17, 97 }, { 18, 102 }, { 21, 103 }, { 22, 104 }, { 23, 105 },
	{ 24, 53 }, { 25, 106 }, { 26, 65 }, { 27, 55 }, { 28, 89 }, { 30, 80 },
	{ 31, 109 }, { 33, 87 }, { 34, 81 }, { 35, 75 }, { 40, 88 }, { 41, 98 },
	{ 42, 110 }, { 43, 95 }, { 47, 118 }, { 50, 111 }, { 52, 52 }, { 53, 114 },
	{ 54, 115 }, { 55, 99 }, { 56, 45 }, { 57, 85 }, { 58, 56 }, { 59, 84 },
	{ 60, 83 }, { 61, 96 }, { 62, 93 }, { 66, 116 }, { 67, 113 }, { 70, 42 },
	{ 71, 122 }, { 73, 119 }, { 75, 121 }, { 77, 120 }, { 79, 123 }, { 81, 124 },
	{ 83, 64 }, { 84, 128 }, { 86, 129 }, { 87, 63 }, { 91, 92 }, { 92, 66 },
	{ 93, 125 }, { 94, 76 }, { 95, 62 }, { 96, 132 }, { 97, 135 }, { 98, 73 },
	{ 99, 133 }, { 101, 46 }, { 102, 134 }, { 103, 49 }, { 105, 58 }, { 107, 94 },
	{ 110, 59 }, { 113, 57 }, { 114, 60 }, { 118, 107 }, { 120, 61 }, { 121, 108 },
	{ 123, 68 }, { 125, 72 }, { 128, 112 }, { 130, 78 }, { 133, 117 }, { 135, 137 },
};

static const struct msm_pinctrl_soc_data bourtzi_tlmm = {
	.pins = bourtzi_pins,
	...
	.ngpios = 137,
	.qup_regs = bourtzi_qup_regs,
	.nqup_regs = ARRAY_SIZE(bourtzi_qup_regs),
	.wakeirq_map = bourtzi_pdc_map,
	.nwakeirq_map = ARRAY_SIZE(bourtzi_pdc_map),
	.egpio_func = 11,
};
...
static int bourtzi_tlmm_probe(struct platform_device *pdev)
{
...
static struct platform_driver bourtzi_tlmm_driver = {
	.driver = {
		.name = "bourtzi-pinctrl",
		.of_match_table = bourtzi_tlmm_of_match,
	},
	.probe = bourtzi_tlmm_probe,
	.remove = msm_pinctrl_remove,
};

static int __init bourtzi_tlmm_init(void)
{
	return platform_driver_register(&bourtzi_tlmm_driver);
}
arch_initcall(bourtzi_tlmm_init);

static void __exit bourtzi_tlmm_exit(void)
{
	platform_driver_unregister(&bourtzi_tlmm_driver);
}
module_exit(bourtzi_tlmm_exit);

MODULE_DESCRIPTION("QTI bourtzi tlmm driver");
MODULE_LICENSE("GPL");
MODULE_DEVICE_TABLE(of, bourtzi_tlmm_of_match);
