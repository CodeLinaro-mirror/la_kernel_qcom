...
static const char *const egpio_groups[] = {
	"gpio74", "gpio75", "gpio76", "gpio77", "gpio85", "gpio86",
...
static const struct pinfunction monaco_functions[] = {
	...
	MSM_PIN_FUNCTION(sdc3_data),
	MSM_PIN_FUNCTION(sdc3_cmd),
	MSM_PIN_FUNCTION(sdc3_clk),
	MSM_PIN_FUNCTION(phase_flag22),
	MSM_PIN_FUNCTION(dac_calib22),
	MSM_PIN_FUNCTION(wci_uart),
	...
	MSM_PIN_FUNCTION(QUP0_L0),
	MSM_PIN_FUNCTION(QUP0_L2),
	MSM_PIN_FUNCTION(QUP0_L1),
	MSM_PIN_FUNCTION(QUP0_L3),
};
...
static const struct msm_pingroup monaco_groups[] = {
	...
	[73] = PINGROUP(73, mdp_vsync, mdp_vsync, mdp_vsync, NA, NA, NA, NA,
			NA, NA, 0x70000, 15),
	[74] = PINGROUP(74, sdc3_data, qdss_gpio11, NA, NA, NA, NA, NA, NA, egpio,
			0x70004, 0),
	[75] = PINGROUP(75, sdc3_data, qdss_gpio12, NA, NA, NA, NA, NA, NA, egpio,
			0, -1),
	...
	[84] = PINGROUP(84, NA, atest_bbrx0, NA, NA, NA, NA, NA, NA, NA,
			0x70014, 2),
	[85] = PINGROUP(85, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[86] = PINGROUP(86, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0x70004, 6),
	[87] = PINGROUP(87, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0x70004, 7),
	[88] = PINGROUP(88, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[89] = PINGROUP(89, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0x70004, 8),
	[90] = PINGROUP(90, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0x70004, 9),
	[91] = PINGROUP(91, qdss_gpio, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[92] = PINGROUP(92, qdss_gpio, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[93] = PINGROUP(93, qdss_gpio15, NA, NA, NA, NA, NA, NA, NA, egpio
			, 0, -1),
	[94] = PINGROUP(94, qdss_gpio5, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[95] = PINGROUP(95, qdss_cti, NA, NA, NA, NA, NA, NA, NA, egpio,
			0x70004, 10),
	[96] = PINGROUP(96, qdss_cti, NA, NA, NA, NA, NA, NA, NA, egpio,
			0x70004, 11),
	[97] = PINGROUP(97, qdss_cti, NA, NA, NA, NA, NA, NA, NA, egpio,
			0x70004, 12),
	[98] = PINGROUP(98, qdss_cti, NA, NA, NA, NA, NA, NA, NA, egpio,
			0x70004, 13),
	[99] = PINGROUP(99, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[100] = PINGROUP(100, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0x70004, 14),
	[101] = PINGROUP(101, QUP0_L0, QUP0_L2, qdss_cti, NA, NA, NA, NA, NA,
			 egpio, 0x70004, 15),
	[102] = PINGROUP(102, QUP0_L1, QUP0_L3, qdss_cti, NA, NA, NA, NA, NA,
			 egpio, 0x70008, 0),
	[103] = PINGROUP(103, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[104] = PINGROUP(104, QUP0_L2, QUP0_L0, NA, NA, NA, NA, NA, NA, egpio,
			 0x70008, 1),
	[105] = PINGROUP(105, QUP0_L3, QUP0_L1, NA, NA, NA, NA, NA, NA, egpio,
			 0x70008, 2),
	[106] = PINGROUP(106, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0x70008, 3),
	[107] = PINGROUP(107, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[108] = PINGROUP(108, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[109] = PINGROUP(109, qdss_cti, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0x70008, 4),
	[110] = PINGROUP(110, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[111] = PINGROUP(111, qdss_cti, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0x70008, 5),
...
static int monaco_tlmm_probe(struct platform_device *pdev)
{
	return msm_pinctrl_probe(pdev, &monaco_pinctrl);
}

static const struct of_device_id monaco_tlmm_of_match[] = {
	{ .compatible = "qcom,monaco-tlmm", },
	{}
};

static struct platform_driver monaco_tlmm_driver = {
	.driver = {
		.name = "monaco-pinctrl",
...
module_platform_driver(monaco_tlmm_driver);

MODULE_DESCRIPTION("QTI monaco TLMM driver");
MODULE_LICENSE("GPL");
MODULE_DEVICE_TABLE(of, monaco_tlmm_of_match);
