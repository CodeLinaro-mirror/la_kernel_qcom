...
static const struct pinfunction monaco_auto_functions[] = {
	...
	MSM_PIN_FUNCTION(cci_async_in3),
	MSM_PIN_FUNCTION(cci_async_in4),
	MSM_PIN_FUNCTION(cci_async_in5),
	...
	MSM_PIN_FUNCTION(hs0_mi2s_data0),
	MSM_PIN_FUNCTION(hs0_mi2s_data1),
	MSM_PIN_FUNCTION(hs0_mi2s_sck),
	MSM_PIN_FUNCTION(hs0_mi2s_ws),
	...
	MSM_PIN_FUNCTION(qup2_se0_l4),
	MSM_PIN_FUNCTION(qup2_se0_l5),
	MSM_PIN_FUNCTION(qup2_se0_l6),
	...
	MSM_PIN_FUNCTION(usb2phy_ac_en0),
	MSM_PIN_FUNCTION(usb2phy_ac_en2),
