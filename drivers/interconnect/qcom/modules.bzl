def register_modules(registry):
    ...
    registry.register(
        name = "drivers/interconnect/qcom/qnoc-diwali",
        out = "qnoc-diwali.ko",
        config = "CONFIG_INTERCONNECT_QCOM_DIWALI",
        srcs = [
            # do not sort
            "drivers/interconnect/qcom/diwali.c",
            "drivers/interconnect/qcom/icc-rpmh.h",
            "drivers/interconnect/qcom/qnoc-qos.h",
        ],
        deps = [
    ...
    registry.register(
        name = "drivers/interconnect/qcom/qnoc-waipio",
        out = "qnoc-waipio.ko",
        config = "CONFIG_INTERCONNECT_QCOM_WAIPIO",
        srcs = [
            # do not sort
            "drivers/interconnect/qcom/waipio.c",
            "drivers/interconnect/qcom/icc-rpmh.h",
            "drivers/interconnect/qcom/qnoc-qos.h",
        ],
        deps = [
    ...
    registry.register(
        name = "drivers/interconnect/qcom/qnoc-glymur",
        out = "qnoc-glymur.ko",
        config = "CONFIG_INTERCONNECT_QCOM_GLYMUR",
        srcs = [
            # do not sort
