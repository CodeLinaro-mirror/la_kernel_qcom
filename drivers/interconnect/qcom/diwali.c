...
static struct qcom_icc_node qnm_gemnoc_cnoc = {
	...
	.links = { SLAVE_AHB2PHY_SOUTH, SLAVE_AHB2PHY_NORTH,
		   ...
		   SLAVE_TME_CFG, SLAVE_UFS_MEM_CFG,
...
static struct qcom_icc_bcm bcm_mm1 = {
	...
	.nodes = { &qnm_camnoc_hf, &qnm_camnoc_icp,
		   ...
		   &qnm_mnoc_hf_cfg, &qnm_mnoc_sf_cfg,
		   &qnm_vapss_hcp, &qnm_video0,
		   &qnm_video_cvp, &qns_mem_noc_sf },
};
...
static struct qcom_icc_desc diwali_aggre1_noc = {
...
static struct qcom_icc_desc diwali_aggre2_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc diwali_clk_virt = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc diwali_config_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc diwali_gem_noc = {
	.config = &icc_regmap_config,
	.nodes = gem_noc_nodes,
...
static struct qcom_icc_desc diwali_lpass_ag_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc diwali_mc_virt = {
	.config = &icc_regmap_config,
	.nodes = mc_virt_nodes,
...
static struct qcom_icc_desc diwali_mmss_noc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc diwali_nsp_noc = {
	.config = &icc_regmap_config,
	.nodes = nsp_noc_nodes,
...
static struct qcom_icc_desc diwali_pcie_anoc = {
	.config = &icc_regmap_config,
...
static struct qcom_icc_desc diwali_system_noc = {
	.config = &icc_regmap_config,
