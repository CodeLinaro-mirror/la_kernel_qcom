 ...
 * @regmap: regmap to the QoS
 * @probe_list: list head for QNoC QoS probes
 * @qos_clks: the clk_bulk_data table of QoS clocks
 * @num_qos_clks: the total number of clk_bulk_data entries
 * @bus_clks: the clk_bulk_data table of bus clocks
 * @num_clks: the total number of clk_bulk_data entries
 * @util_factor: flag used to set util factor from dtsi or default values.
 ...
 * @regmap: regmap to the QoS
 * @qosbox: qcom icc qosbox registers and configuration
 * @noc_ops: noc_ops to set QoS
