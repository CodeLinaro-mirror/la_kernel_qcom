...
static struct qcom_icc_qosbox mas_venus0 = {
	.regs = icc_qnoc_qos_regs[ICC_QNOC_QOSGEN_TYPE_RPMH],
	.num_ports = 1,
	.offsets = { 0x1e000, },
	.config = &(struct qos_config) {
...
static struct qcom_icc_qosbox mas_venus_cpu = {
	.regs = icc_qnoc_qos_regs[ICC_QNOC_QOSGEN_TYPE_RPMH],
	.num_ports = 1,
	.offsets = { 0x22000, },
	.config = &(struct qos_config) {
...
static struct qcom_icc_qosbox mas_camera_rt = {
	.regs = icc_qnoc_qos_regs[ICC_QNOC_QOSGEN_TYPE_RPMH],
	.num_ports = 1,
	.offsets = { 0x1f000, },
	.config = &(struct qos_config) {
...
static struct qcom_icc_qosbox mas_mdp0 = {
	.regs = icc_qnoc_qos_regs[ICC_QNOC_QOSGEN_TYPE_RPMH],
	.num_ports = 1,
	.offsets = { 0x1a000, },
	.config = &(struct qos_config) {
...
static void qnoc_sync_state(struct device *dev)
{
	...
	pr_debug("Bengal ICC Sync State done\n");
}
