...
static struct clk_vdd_class *gcc_malabar_regulators[] = {
	&vdd_cx,
	&vdd_mx,
};
...
static struct clk_regmap_mux gcc_usb2_prim_phy_pipe_clk_src = {
	.reg = 0x1a070,
	.shift = 0,
	.width = 2,
	...
	.clkr = {
		.hw.init = &(const struct clk_init_data) {
			.name = "gcc_usb2_prim_phy_pipe_clk_src",
...
static struct clk_rcg2 gcc_camss_axi_clk_src = {
	...
	.clkr.vdd_data = {
		.vdd_classes = gcc_malabar_regulators,
		.num_vdd_classes = ARRAY_SIZE(gcc_malabar_regulators),
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
			[VDD_LOWER] = 19200000,
			[VDD_LOW] = 150000000,
...
static const struct freq_tbl ftbl_gcc_camss_mclk0_clk_src[] = {
	F(19200000, P_GPLL9_OUT_MAIN, 1, 1, 50),
...
static const struct freq_tbl ftbl_gcc_camss_tfe_0_clk_src[] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
	F(135333333, P_GPLL10_OUT_MAIN, 9, 0, 0),
	F(143294117, P_GPLL10_OUT_MAIN, 8.5, 0, 0),
	F(152250000, P_GPLL10_OUT_MAIN, 8, 0, 0),
	F(162400000, P_GPLL10_OUT_MAIN, 7.5, 0, 0),
	F(174000000, P_GPLL10_OUT_MAIN, 7, 0, 0),
	F(187384615, P_GPLL10_OUT_MAIN, 6.5, 0, 0),
	F(203000000, P_GPLL10_OUT_MAIN, 6, 0, 0),
	F(217500000, P_GPLL10_OUT_MAIN, 5.5, 0, 0),
	F(243600000, P_GPLL10_OUT_MAIN, 5, 0, 0),
	F(270666667, P_GPLL10_OUT_MAIN, 4.5, 0, 0),
	F(304500000, P_GPLL10_OUT_MAIN, 4, 0, 0),
	F(348000000, P_GPLL10_OUT_MAIN, 3.5, 0, 0),
	F(390000000, P_GPLL10_OUT_MAIN, 2, 0, 0),
	F(406000000, P_GPLL10_OUT_MAIN, 3, 0, 0),
	F(487000000, P_GPLL10_OUT_MAIN, 2, 0, 0),
	F(609000000, P_GPLL10_OUT_MAIN, 2, 0, 0),
	{ }
};
...
static const struct freq_tbl ftbl_gcc_camss_tfe_1_clk_src[] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
	F(135333333, P_GPLL12_OUT_MAIN, 9, 0, 0),
	F(143294117, P_GPLL12_OUT_MAIN, 8.5, 0, 0),
	F(152250000, P_GPLL12_OUT_MAIN, 8, 0, 0),
	F(162400000, P_GPLL12_OUT_MAIN, 7.5, 0, 0),
	F(174000000, P_GPLL12_OUT_MAIN, 7, 0, 0),
	F(187384615, P_GPLL12_OUT_MAIN, 6.5, 0, 0),
	F(203000000, P_GPLL12_OUT_MAIN, 6, 0, 0),
	F(217500000, P_GPLL12_OUT_MAIN, 5.5, 0, 0),
	F(243600000, P_GPLL12_OUT_MAIN, 5, 0, 0),
	F(270666667, P_GPLL12_OUT_MAIN, 4.5, 0, 0),
	F(304500000, P_GPLL12_OUT_MAIN, 4, 0, 0),
	F(348000000, P_GPLL12_OUT_MAIN, 3.5, 0, 0),
	F(390000000, P_GPLL12_OUT_MAIN, 2, 0, 0),
	F(406000000, P_GPLL12_OUT_MAIN, 3, 0, 0),
	F(487000000, P_GPLL12_OUT_MAIN, 2, 0, 0),
	F(609000000, P_GPLL12_OUT_MAIN, 2, 0, 0),
	{ }
};
...
static const struct freq_tbl ftbl_gcc_usb20_prim_master_clk_src[] = {
	F(66666667, P_GPLL0_OUT_EVEN, 4.5, 0, 0),
	F(120000000, P_GPLL0_OUT_MAIN, 5, 0, 0),
	{ }
};

static struct clk_rcg2 gcc_usb20_prim_master_clk_src = {
	.cmd_rcgr = 0x1a034,
	.mnd_width = 8,
	.hid_width = 5,
	.parent_map = gcc_parent_map_0,
	.freq_tbl = ftbl_gcc_usb20_prim_master_clk_src,
	.enable_safe_config = true,
	.flags = HW_CLK_CTRL_MODE,
	.clkr.hw.init = &(const struct clk_init_data) {
		.name = "gcc_usb20_prim_master_clk_src",
		.parent_data = gcc_parent_data_0,
		.num_parents = ARRAY_SIZE(gcc_parent_data_0),
		.flags = CLK_SET_RATE_PARENT,
		.ops = &clk_rcg2_ops,
...
static const struct freq_tbl ftbl_gcc_usb20_prim_mock_utmi_clk_src[] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
	{ }
};

static struct clk_rcg2 gcc_usb20_prim_mock_utmi_clk_src = {
	.cmd_rcgr = 0x1a04c,
	.mnd_width = 0,
	.hid_width = 5,
	.parent_map = gcc_parent_map_0,
	.freq_tbl = ftbl_gcc_usb20_prim_mock_utmi_clk_src,
	.enable_safe_config = true,
	.flags = HW_CLK_CTRL_MODE,
	.clkr.hw.init = &(const struct clk_init_data) {
		.name = "gcc_usb20_prim_mock_utmi_clk_src",
		.parent_data = gcc_parent_data_0,
		.num_parents = ARRAY_SIZE(gcc_parent_data_0),
		.flags = CLK_SET_RATE_PARENT,
		.ops = &clk_rcg2_ops,
...
static struct clk_rcg2 gcc_usb2_prim_phy_aux_clk_src = {
	.cmd_rcgr = 0x1a074,
	.mnd_width = 0,
	.hid_width = 5,
	...
	.flags = HW_CLK_CTRL_MODE,
	.clkr.hw.init = &(const struct clk_init_data) {
		.name = "gcc_usb2_prim_phy_aux_clk_src",
...
static const struct freq_tbl ftbl_gcc_video_venus_clk_src[] = {
	...
	F(420000000, P_GPLL11_OUT_MAIN, 2, 0, 0),
	{ }
};
...
static struct clk_regmap_div gcc_usb20_prim_mock_utmi_postdiv_clk_src = {
	.reg = 0x1a064,
	.shift = 0,
	.width = 4,
	.clkr.hw.init = &(const struct clk_init_data) {
		.name = "gcc_usb20_prim_mock_utmi_postdiv_clk_src",
		.parent_hws = (const struct clk_hw*[]) {
			&gcc_usb20_prim_mock_utmi_clk_src.clkr.hw,
		},
		.num_parents = 1,
		.flags = CLK_SET_RATE_PARENT,
...
static struct clk_branch gcc_cfg_noc_usb2_prim_axi_clk = {
	...
	.clkr = {
		...
		.hw.init = &(const struct clk_init_data) {
			...
			.parent_hws = (const struct clk_hw*[]) {
				&gcc_usb20_prim_master_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_usb20_prim_master_clk = {
	.halt_reg = 0x1a024,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0x1a024,
		.enable_mask = BIT(0),
		.hw.init = &(const struct clk_init_data) {
			.name = "gcc_usb20_prim_master_clk",
			.parent_hws = (const struct clk_hw*[]) {
				&gcc_usb20_prim_master_clk_src.clkr.hw,
			},
			.num_parents = 1,
...
static struct clk_branch gcc_usb20_prim_mock_utmi_clk = {
	.halt_reg = 0x1a030,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0x1a030,
		.enable_mask = BIT(0),
		.hw.init = &(const struct clk_init_data) {
			.name = "gcc_usb20_prim_mock_utmi_clk",
			.parent_hws = (const struct clk_hw*[]) {
				&gcc_usb20_prim_mock_utmi_postdiv_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_usb20_prim_sleep_clk = {
	.halt_reg = 0x1a02c,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0x1a02c,
...
static struct clk_branch gcc_usb2_prim_phy_com_aux_clk = {
	.halt_reg = 0x1a068,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0x1a068,
		.enable_mask = BIT(0),
		.hw.init = &(const struct clk_init_data) {
			.name = "gcc_usb2_prim_phy_com_aux_clk",
			.parent_hws = (const struct clk_hw*[]) {
				&gcc_usb2_prim_phy_aux_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_usb2_prim_phy_pipe_clk = {
	.halt_reg = 0x1a06c,
	...
	.clkr = {
		...
		.enable_mask = BIT(0),
		.hw.init = &(const struct clk_init_data) {
			.name = "gcc_usb2_prim_phy_pipe_clk",
			.parent_hws = (const struct clk_hw*[]) {
				&gcc_usb2_prim_phy_pipe_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_regmap *gcc_malabar_clocks[] = {
	...
	[GCC_USB20_PRIM_MASTER_CLK] = &gcc_usb20_prim_master_clk.clkr,
	[GCC_USB20_PRIM_MASTER_CLK_SRC] = &gcc_usb20_prim_master_clk_src.clkr,
	[GCC_USB20_PRIM_MOCK_UTMI_CLK] = &gcc_usb20_prim_mock_utmi_clk.clkr,
	[GCC_USB20_PRIM_MOCK_UTMI_CLK_SRC] = &gcc_usb20_prim_mock_utmi_clk_src.clkr,
	[GCC_USB20_PRIM_MOCK_UTMI_POSTDIV_CLK_SRC] = &gcc_usb20_prim_mock_utmi_postdiv_clk_src.clkr,
	[GCC_USB20_PRIM_SLEEP_CLK] = &gcc_usb20_prim_sleep_clk.clkr,
	[GCC_USB2_CLKREF_EN] = &gcc_usb2_clkref_en.clkr,
	[GCC_USB2_PRIM_PHY_AUX_CLK_SRC] = &gcc_usb2_prim_phy_aux_clk_src.clkr,
	[GCC_USB2_PRIM_PHY_COM_AUX_CLK] = &gcc_usb2_prim_phy_com_aux_clk.clkr,
	[GCC_USB2_PRIM_PHY_PIPE_CLK] = &gcc_usb2_prim_phy_pipe_clk.clkr,
	[GCC_USB2_PRIM_PHY_PIPE_CLK_SRC] = &gcc_usb2_prim_phy_pipe_clk_src.clkr,
...
static const struct qcom_reset_map gcc_malabar_resets[] = {
...
static const struct clk_rcg_dfs_data gcc_malabar_dfs_clocks[] = {
...
static const struct regmap_config gcc_malabar_regmap_config = {
	.reg_bits = 32,
	.reg_stride = 4,
	.val_bits = 32,
...
static const struct qcom_cc_desc gcc_malabar_desc = {
	.config = &gcc_malabar_regmap_config,
	.clks = gcc_malabar_clocks,
	.num_clks = ARRAY_SIZE(gcc_malabar_clocks),
	.resets = gcc_malabar_resets,
	.num_resets = ARRAY_SIZE(gcc_malabar_resets),
	.clk_regulators = gcc_malabar_regulators,
	.num_clk_regulators = ARRAY_SIZE(gcc_malabar_regulators),
};

static const struct of_device_id gcc_malabar_match_table[] = {
	{ .compatible = "qcom,malabar-gcc" },
	{ }
};
MODULE_DEVICE_TABLE(of, gcc_malabar_match_table);

static int gcc_malabar_probe(struct platform_device *pdev)
{
	struct regmap *regmap;
	int ret;

	regmap = qcom_cc_map(pdev, &gcc_malabar_desc);
	if (IS_ERR(regmap))
	...
	ret = qcom_cc_register_rcg_dfs(regmap, gcc_malabar_dfs_clocks,
				       ARRAY_SIZE(gcc_malabar_dfs_clocks));
	if (ret)
		return ret;
	...
	ret = qcom_cc_really_probe(&pdev->dev, &gcc_malabar_desc, regmap);
	if (ret)
...
static void gcc_malabar_sync_state(struct device *dev)
{
	qcom_cc_sync_state(dev, &gcc_malabar_desc);
}

static struct platform_driver gcc_malabar_driver = {
	.probe = gcc_malabar_probe,
	.driver = {
		.name = "gcc-malabar",
		.of_match_table = gcc_malabar_match_table,
		.sync_state = gcc_malabar_sync_state,
	},
};

static int __init gcc_malabar_init(void)
{
	return platform_driver_register(&gcc_malabar_driver);
}
subsys_initcall(gcc_malabar_init);

static void __exit gcc_malabar_exit(void)
{
	platform_driver_unregister(&gcc_malabar_driver);
}
module_exit(gcc_malabar_exit);

MODULE_DESCRIPTION("QTI GCC MALABAR Driver");
MODULE_LICENSE("GPL");
