...
static const char *const gcc_debug_mux_parent_names[] = {
	...
	"gcc_usb20_prim_master_clk",
	"gcc_usb20_prim_mock_utmi_clk",
	"gcc_usb20_prim_sleep_clk",
	"gcc_usb2_prim_phy_com_aux_clk",
	"gcc_usb2_prim_phy_pipe_clk",
	"gcc_vcodec0_axi_clk",
	"gcc_venus_ahb_clk",
...
static int gcc_debug_mux_sels[] = {
	0xD5,		/* apss_cc_debug_mux */
	0x52,		/* disp_cc_debug_mux */
	0x84,		/* gcc_ahb2phy_csi_clk */
	0x85,		/* gcc_ahb2phy_usb_clk */
	0xBC,		/* gcc_bimc_gpu_axi_clk */
	0xA1,		/* gcc_boot_rom_ahb_clk */
	0x5C,		/* gcc_cam_throttle_nrt_clk */
	0x5B,		/* gcc_cam_throttle_rt_clk */
	0x160,		/* gcc_camss_axi_clk */
	0x15D,		/* gcc_camss_cci_0_clk */
	0x15E,		/* gcc_camss_cci_1_clk */
	0x150,		/* gcc_camss_cphy_0_clk */
	0x151,		/* gcc_camss_cphy_1_clk */
	0x152,		/* gcc_camss_cphy_2_clk */
	0x143,		/* gcc_camss_csi0phytimer_clk */
	0x144,		/* gcc_camss_csi1phytimer_clk */
	0x145,		/* gcc_camss_csi2phytimer_clk */
	0x146,		/* gcc_camss_mclk0_clk */
	0x147,		/* gcc_camss_mclk1_clk */
	0x148,		/* gcc_camss_mclk2_clk */
	0x149,		/* gcc_camss_mclk3_clk */
	0x166,		/* gcc_camss_nrt_axi_clk */
	0x15C,		/* gcc_camss_ope_ahb_clk */
	0x15A,		/* gcc_camss_ope_clk */
	0x168,		/* gcc_camss_rt_axi_clk */
	0x14A,		/* gcc_camss_tfe_0_clk */
	0x14E,		/* gcc_camss_tfe_0_cphy_rx_clk */
	0x153,		/* gcc_camss_tfe_0_csid_clk */
	0x14C,		/* gcc_camss_tfe_1_clk */
	0x14F,		/* gcc_camss_tfe_1_cphy_rx_clk */
	0x155,		/* gcc_camss_tfe_1_csid_clk */
	0x15F,		/* gcc_camss_top_ahb_clk */
	0x164,		/* gcc_camss_top_shift_clk */
	0x25,		/* gcc_cfg_noc_usb2_prim_axi_clk */
	0x57,		/* gcc_disp_gpll0_div_clk_src */
	0x4D,		/* gcc_disp_hf_axi_clk */
	0x5D,		/* gcc_disp_sleep_clk */
	0x59,		/* gcc_disp_throttle_core_clk */
	0xDF,		/* gcc_gp1_clk */
	0xE0,		/* gcc_gp2_clk */
	0xE1,		/* gcc_gp3_clk */
	0x113,		/* gcc_gpu_gpll0_clk_src */
	0x114,		/* gcc_gpu_gpll0_div_clk_src */
	0x111,		/* gcc_gpu_memnoc_gfx_clk */
	0x9D,		/* gcc_pdm2_clk */
	0x9B,		/* gcc_pdm_ahb_clk */
	0x9C,		/* gcc_pdm_xo4_clk */
	0x9E,		/* gcc_prng_ahb_clk */
	0x4A,		/* gcc_qmip_camera_nrt_ahb_clk */
	0x58,		/* gcc_qmip_camera_rt_ahb_clk */
	0x4B,		/* gcc_qmip_disp_ahb_clk */
	0x115,		/* gcc_qmip_gpu_cfg_ahb_clk */
	0x49,		/* gcc_qmip_video_vcodec_ahb_clk */
	0x8C,		/* gcc_qupv3_wrap0_core_2x_clk */
	0x8B,		/* gcc_qupv3_wrap0_core_clk */
	0x8D,		/* gcc_qupv3_wrap0_s0_clk */
	0x8E,		/* gcc_qupv3_wrap0_s1_clk */
	0x8F,		/* gcc_qupv3_wrap0_s2_clk */
	0x90,		/* gcc_qupv3_wrap0_s3_clk */
	0x91,		/* gcc_qupv3_wrap0_s4_clk */
	...
	0x89,		/* gcc_qupv3_wrap_0_m_ahb_clk */
	0x8A,		/* gcc_qupv3_wrap_0_s_ahb_clk */
	0x92,		/* gcc_qupv3_wrap_1_m_ahb_clk */
	0x93,		/* gcc_qupv3_wrap_1_s_ahb_clk */
	0x11A,		/* gcc_sdcc1_ahb_clk */
	0x119,		/* gcc_sdcc1_apps_clk */
	0x11B,		/* gcc_sdcc1_ice_core_clk */
	0x87,		/* gcc_sdcc2_ahb_clk */
	0x86,		/* gcc_sdcc2_apps_clk */
	0x19,		/* gcc_sys_noc_ufs_phy_axi_clk */
	0x18,		/* gcc_sys_noc_usb2_prim_axi_clk */
	...
	0x142,		/* gcc_ufs_phy_rx_symbol_1_clk */
	0x139,		/* gcc_ufs_phy_tx_symbol_0_clk */
	0x13D,		/* gcc_ufs_phy_unipro_core_clk */
	0x7A,		/* gcc_usb20_prim_master_clk */
	0x7C,		/* gcc_usb20_prim_mock_utmi_clk */
	0x7B,		/* gcc_usb20_prim_sleep_clk */
	0x7D,		/* gcc_usb2_prim_phy_com_aux_clk */
	0x7E,		/* gcc_usb2_prim_phy_pipe_clk */
	0x16E,		/* gcc_vcodec0_axi_clk */
	0x16F,		/* gcc_venus_ahb_clk */
	0x16D,		/* gcc_venus_ctl_axi_clk */
	0x4C,		/* gcc_video_axi0_clk */
	0x5A,		/* gcc_video_throttle_core_clk */
	0x16B,		/* gcc_video_vcodec0_sys_clk */
	0x169,		/* gcc_video_venus_ctl_clk */
	0x110,		/* gpu_cc_debug_mux */
	0xCE,		/* mc_cc_debug_mux */
	0x23,		/* measure_only_cnoc_clk */
	0x47,		/* measure_only_gcc_camera_ahb_clk */
	0x4F,		/* measure_only_gcc_camera_xo_clk */
	0xD0,		/* measure_only_gcc_cpuss_gnoc_clk */
	0x48,		/* measure_only_gcc_disp_ahb_clk */
	0x50,		/* measure_only_gcc_disp_xo_clk */
	0x10E,		/* measure_only_gcc_gpu_cfg_ahb_clk */
	0xA,		/* measure_only_gcc_sys_noc_cpuss_ahb_clk */
	0x46,		/* measure_only_gcc_video_ahb_clk */
	0x4E,		/* measure_only_gcc_video_xo_clk */
	0xEB,		/* measure_only_ipa_2x_clk */
...
static struct clk_hw *debugcc_malabar_hws[] = {
...
static const struct of_device_id clk_debug_match_table[] = {
	{ .compatible = "qcom,malabar-debugcc" },
	{ }
};

static int clk_debug_malabar_probe(struct platform_device *pdev)
{
	struct clk *clk;
	int ret = 0, i;
	...
	for (i = 0; i < ARRAY_SIZE(debugcc_malabar_hws); i++) {
		clk = devm_clk_register(&pdev->dev, debugcc_malabar_hws[i]);
		if (IS_ERR(clk)) {
			dev_err(&pdev->dev, "Unable to register %s, err:(%ld)\n",
				qcom_clk_hw_get_name(debugcc_malabar_hws[i]),
				PTR_ERR(clk));
			return PTR_ERR(clk);
		}
	}
...
static struct platform_driver clk_debug_driver = {
	.probe = clk_debug_malabar_probe,
	.driver = {
		.name = "malabar-debugcc",
		.of_match_table = clk_debug_match_table,
	},
};

static int __init clk_debug_malabar_init(void)
{
	return platform_driver_register(&clk_debug_driver);
}
fs_initcall(clk_debug_malabar_init);

MODULE_DESCRIPTION("QTI DEBUG CC MALABAR Driver");
MODULE_LICENSE("GPL");
