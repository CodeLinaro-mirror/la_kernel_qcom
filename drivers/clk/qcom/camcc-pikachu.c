...
#include <dt-bindings/clock/qcom,pikachu-camcc.h>
...
static struct clk_vdd_class *cam_cc_pikachu_regulators[] = {
	&vdd_mm,
	&vdd_mx,
	&vdd_mxc,
};

static struct clk_vdd_class *cam_cc_pikachu_regulators_1[] = {
	&vdd_mm,
	&vdd_mxc,
};
...
static struct clk_rcg2 cam_cc_bps_clk_src = {
	...
	.clkr.vdd_data = {
		.vdd_classes = cam_cc_pikachu_regulators_1,
		.num_vdd_classes = ARRAY_SIZE(cam_cc_pikachu_regulators_1),
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
			[VDD_LOWER_D1_1] = 150000000,
			[VDD_LOWER] = 200000000,
			[VDD_LOW] = 400000000,
...
static const struct freq_tbl ftbl_cam_cc_csi2phytimer_clk_src[] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
	F(400000000, P_CAM_CC_PLL0_OUT_ODD, 1, 0, 0),
	{ }
};
...
static struct clk_rcg2 cam_cc_csi2phytimer_clk_src = {
	...
	.hid_width = 5,
	.parent_map = cam_cc_parent_map_0,
	.freq_tbl = ftbl_cam_cc_csi2phytimer_clk_src,
	.enable_safe_config = true,
	.flags = HW_CLK_CTRL_MODE,
	.clkr.hw.init = &(const struct clk_init_data) {
...
static const struct freq_tbl ftbl_cam_cc_ife_0_clk_src[] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
	F(180000000, P_CAM_CC_PLL3_OUT_EVEN, 1, 0, 0),
...
static const struct freq_tbl ftbl_cam_cc_ife_lite_0_csid_clk_src[] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
	F(100000000, P_CAM_CC_PLL0_OUT_MAIN, 12, 0, 0),
	F(300000000, P_CAM_CC_PLL0_OUT_MAIN, 4, 0, 0),
	F(400000000, P_CAM_CC_PLL0_OUT_MAIN, 3, 0, 0),
	F(480000000, P_CAM_CC_PLL0_OUT_MAIN, 2.5, 0, 0),
	{ }
...
static const struct freq_tbl ftbl_cam_cc_ipe_nps_clk_src[] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
	F(127500000, P_CAM_CC_PLL1_OUT_EVEN, 1, 0, 0),
...
static const struct freq_tbl ftbl_cam_cc_mclk0_clk_src[] = {
	F(19200000, P_CAM_CC_PLL2_OUT_EVEN, 10, 1, 5),
...
static struct clk_regmap *cam_cc_pikachu_clocks[] = {
...
static struct gdsc *cam_cc_pikachu_gdscs[] = {
...
static const struct qcom_reset_map cam_cc_pikachu_resets[] = {
...
static const struct regmap_config cam_cc_pikachu_regmap_config = {
	.reg_bits = 32,
	.reg_stride = 4,
	.val_bits = 32,
...
static struct qcom_cc_desc cam_cc_pikachu_desc = {
	.config = &cam_cc_pikachu_regmap_config,
	.clks = cam_cc_pikachu_clocks,
	.num_clks = ARRAY_SIZE(cam_cc_pikachu_clocks),
	.resets = cam_cc_pikachu_resets,
	.num_resets = ARRAY_SIZE(cam_cc_pikachu_resets),
	.clk_regulators = cam_cc_pikachu_regulators,
	.num_clk_regulators = ARRAY_SIZE(cam_cc_pikachu_regulators),
	.critical_clk_en = critical_clk_list,
	.num_critical_clk = ARRAY_SIZE(critical_clk_list),
	.gdscs = cam_cc_pikachu_gdscs,
	.num_gdscs = ARRAY_SIZE(cam_cc_pikachu_gdscs),
};

static const struct of_device_id cam_cc_pikachu_match_table[] = {
	{ .compatible = "qcom,pikachu-camcc" },
	{ }
};
MODULE_DEVICE_TABLE(of, cam_cc_pikachu_match_table);

static int cam_cc_pikachu_probe(struct platform_device *pdev)
{
	struct regmap *regmap;
	int ret;

	regmap = qcom_cc_map(pdev, &cam_cc_pikachu_desc);
	if (IS_ERR(regmap))
		return PTR_ERR(regmap);

	ret = register_qcom_clks_pm(pdev, true, &cam_cc_pikachu_desc);
	if (ret)
	...
	ret = qcom_cc_really_probe(&pdev->dev, &cam_cc_pikachu_desc, regmap);
	if (ret) {
...
static void cam_cc_pikachu_sync_state(struct device *dev)
{
	qcom_cc_sync_state(dev, &cam_cc_pikachu_desc);
}

static struct platform_driver cam_cc_pikachu_driver = {
	.probe = cam_cc_pikachu_probe,
	.driver = {
		.name = "camcc-pikachu",
		.of_match_table = cam_cc_pikachu_match_table,
		.sync_state = cam_cc_pikachu_sync_state,
	},
};

module_platform_driver(cam_cc_pikachu_driver);

MODULE_DESCRIPTION("QTI CAMCC PIKACHU Driver");
MODULE_LICENSE("GPL");
