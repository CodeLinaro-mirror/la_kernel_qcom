...
static struct clk_init_data disp_cc_pll0_sa6155 = {
	.name = "disp_cc_pll0",
...
static const struct of_device_id disp_cc_sm6150_match_table[] = {
	{ .compatible = "qcom,sm6150-dispcc" },
	{ .compatible = "qcom,sa6155-dispcc" },
	{ }
};
...
static void disp_cc_sm6150_sync_state(struct device *dev)
{
	qcom_cc_sync_state(dev, &disp_cc_sm6150_desc);
}

static struct platform_driver disp_cc_sm6150_driver = {
	.probe = disp_cc_sm6150_probe,
	.driver = {
		.name = "disp_cc-sm6150",
		.of_match_table = disp_cc_sm6150_match_table,
		.sync_state = disp_cc_sm6150_sync_state,
	},
};

static int __init disp_cc_sm6150_init(void)
{
...
{
	platform_driver_unregister(&disp_cc_sm6150_driver);
}
module_exit(disp_cc_sm6150_exit);

MODULE_DESCRIPTION("QTI DISP_CC SM6150 Driver");
MODULE_LICENSE("GPL");
