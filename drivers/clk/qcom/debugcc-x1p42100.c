...
static int gcc_debug_mux_sels[] = {
	...
	0x27E,		/* gcc_sdcc1_ahb_clk */
	0x27F,		/* gcc_sdcc1_apps_clk */
	0x281,		/* gcc_sdcc1_ice_core_clk */
...
static int video_cc_debug_mux_sels[] = {
	0xB,		/* measure_only_video_cc_ahb_clk */
	0x11,		/* measure_only_video_cc_sleep_clk */
	0xC,		/* measure_only_video_cc_xo_clk */
	0x5,		/* video_cc_mvs0_bse_clk */
	0x7,		/* video_cc_mvs0_clk */
	0xD,		/* video_cc_mvs0_shift_clk */
	0x1,		/* video_cc_mvs0c_clk */
	0xE,		/* video_cc_mvs0c_shift_clk */
	0x9,		/* video_cc_mvs1_clk */
	0xF,		/* video_cc_mvs1_shift_clk */
	0x3,		/* video_cc_mvs1c_clk */
...
static struct clk_hw *debugcc_x1p42100_hws[] = {
...
static int clk_debug_x1p42100_probe(struct platform_device *pdev)
{
	struct clk *clk;
	int ret = 0, i;
	...
	for (i = 0; i < ARRAY_SIZE(debugcc_x1p42100_hws); i++) {
		clk = devm_clk_register(&pdev->dev, debugcc_x1p42100_hws[i]);
		if (IS_ERR(clk)) {
			dev_err(&pdev->dev, "Unable to register %s, err:(%ld)\n",
				qcom_clk_hw_get_name(debugcc_x1p42100_hws[i]),
				PTR_ERR(clk));
			return PTR_ERR(clk);
		}
	}
...
static struct platform_driver clk_debug_driver = {
	.probe = clk_debug_x1p42100_probe,
	.driver = {
		.name = "x1p42100-debugcc",
		.of_match_table = clk_debug_match_table,
	},
};

static int __init clk_debug_x1p42100_init(void)
{
	return platform_driver_register(&clk_debug_driver);
}
fs_initcall(clk_debug_x1p42100_init);

MODULE_DESCRIPTION("QTI DEBUG CC X1P42100 Driver");
MODULE_LICENSE("GPL");
