...
#include <dt-bindings/clock/qcom,pikachu-evacc.h>
...
static struct clk_vdd_class *eva_cc_pikachu_regulators[] = {
	&vdd_mm,
	&vdd_mxc,
};
...
static struct clk_rcg2 eva_cc_mvs0_clk_src = {
	...
	.clkr.vdd_data = {
		.vdd_classes = eva_cc_pikachu_regulators,
...
static struct clk_regmap *eva_cc_pikachu_clocks[] = {
...
static const struct qcom_reset_map eva_cc_pikachu_resets[] = {
...
static const struct regmap_config eva_cc_pikachu_regmap_config = {
	.reg_bits = 32,
	.reg_stride = 4,
	.val_bits = 32,
	.max_register = 0xa004,
...
static struct qcom_cc_desc eva_cc_pikachu_desc = {
	.config = &eva_cc_pikachu_regmap_config,
	.clks = eva_cc_pikachu_clocks,
	.num_clks = ARRAY_SIZE(eva_cc_pikachu_clocks),
	.resets = eva_cc_pikachu_resets,
...
static const struct of_device_id eva_cc_pikachu_match_table[] = {
	{ .compatible = "qcom,pikachu-evacc" },
	{ }
};
MODULE_DEVICE_TABLE(of, eva_cc_pikachu_match_table);
...
static void eva_cc_pikachu_sync_state(struct device *dev)
{
...
module_platform_driver(eva_cc_pikachu_driver);

MODULE_DESCRIPTION("QTI EVACC PIKACHU Driver");
MODULE_LICENSE("GPL");
