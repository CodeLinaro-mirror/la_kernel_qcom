...
static int gcc_debug_mux_sels[] = {
	...
	0x1E0,		/* gcc_vcodec0_axi_clk */
	0x1DF,		/* gcc_venus_ctl_axi_clk */
	0x73,		/* gcc_video_throttle_core_clk */
	0x1DD,		/* gcc_video_vcodec0_sys_clk */
	0x1DB,		/* gcc_video_venus_ctl_clk */
	0x16E,		/* gpu_cc_debug_mux */
	0x100,		/* mc_cc_debug_mux */
...
static int gpu_cc_debug_mux_sels[] = {
	...
	0x25,		/* gpu_cc_cx_gfx3d_clk */
	0x26,		/* gpu_cc_cx_gfx3d_slv_clk */
	...
	0x11,		/* gpu_cc_gx_cxo_clk */
	0x13,		/* gpu_cc_gx_ff_clk */
	0xE,		/* gpu_cc_gx_gfx3d_clk */
...
static struct clk_hw *debugcc_sm4450_hws[] = {
...
static const struct of_device_id clk_debug_match_table[] = {
	{ .compatible = "qcom,sm4450-debugcc" },
	{ }
};
...
static int clk_debug_sm4450_probe(struct platform_device *pdev)
{
	...
	for (i = 0; i < ARRAY_SIZE(debugcc_sm4450_hws); i++) {
		clk = devm_clk_register(&pdev->dev, debugcc_sm4450_hws[i]);
		if (IS_ERR(clk)) {
			dev_err(&pdev->dev, "Unable to register %s, err:(%ld)\n",
				clk_hw_get_name(debugcc_sm4450_hws[i]),
				PTR_ERR(clk));
			return PTR_ERR(clk);
		}
	}
...
static int __init clk_debug_sm4450_init(void)
{
	return platform_driver_register(&clk_debug_driver);
}
fs_initcall(clk_debug_sm4450_init);

MODULE_DESCRIPTION("QTI DEBUG CC SM4450 Driver");
MODULE_LICENSE("GPL");
