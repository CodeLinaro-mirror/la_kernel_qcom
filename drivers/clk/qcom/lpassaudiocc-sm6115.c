...
#include <dt-bindings/clock/qcom,lpassaudiocc-sm6115.h>
...
static struct clk_vdd_class *lpass_audio_cc_sm6115_regulators[] = {
	&vdd_lpi_cx,
};
...
static const struct clk_div_table post_div_table_lpass_audio_cc_dig_pll_out_aux[] = {
	{ 0x5, 5 },
	{ }
};
...
static struct clk_alpha_pll_postdiv lpass_audio_cc_dig_pll_out_aux = {
	.offset = 0x3e8,
	.post_div_shift = 15,
	.post_div_table = post_div_table_lpass_audio_cc_dig_pll_out_aux,
	.num_post_div = ARRAY_SIZE(post_div_table_lpass_audio_cc_dig_pll_out_aux),
	.width = 3,
	.regs = clk_alpha_pll_regs[CLK_ALPHA_PLL_TYPE_DEFAULT],
...
static const struct clk_div_table post_div_table_lpass_audio_cc_pll_out_aux[] = {
	{ 0x1, 2 },
	{ }
};
...
static struct clk_alpha_pll_postdiv lpass_audio_cc_pll_out_aux = {
	.offset = 0x7d0,
	.post_div_shift = 8,
	.post_div_table = post_div_table_lpass_audio_cc_pll_out_aux,
	.num_post_div = ARRAY_SIZE(post_div_table_lpass_audio_cc_pll_out_aux),
	.width = 2,
	.regs = clk_alpha_pll_regs[CLK_ALPHA_PLL_TYPE_BRAMMO],
	.clkr.hw.init = &(const struct clk_init_data) {
...
static const struct clk_parent_data lpass_audio_cc_parent_data_0[] = {
	{ .fw_name = "bi_tcxo" },
	{ .hw = &lpass_audio_cc_pll_out_aux.clkr.hw },
	{ .hw = &lpass_audio_cc_dig_pll_out_aux.clkr.hw },
...
static struct clk_regmap *lpass_audio_cc_sm6115_clocks[] = {
...
static const struct qcom_reset_map lpass_audio_cc_sm6115_resets[] = {
...
static const struct regmap_config lpass_audio_cc_sm6115_regmap_config = {
	.reg_bits = 32,
	.reg_stride = 4,
	.val_bits = 32,
...
static const struct qcom_cc_desc lpass_audio_cc_sm6115_desc = {
	.config = &lpass_audio_cc_sm6115_regmap_config,
	.clks = lpass_audio_cc_sm6115_clocks,
	.num_clks = ARRAY_SIZE(lpass_audio_cc_sm6115_clocks),
	.resets = lpass_audio_cc_sm6115_resets,
	.num_resets = ARRAY_SIZE(lpass_audio_cc_sm6115_resets),
	.clk_regulators = lpass_audio_cc_sm6115_regulators,
	.num_clk_regulators = ARRAY_SIZE(lpass_audio_cc_sm6115_regulators),
};

static const struct of_device_id lpass_audio_cc_sm6115_match_table[] = {
	{ .compatible = "qcom,lpassaudiocc-sm6115" },
	{ }
};
MODULE_DEVICE_TABLE(of, lpass_audio_cc_sm6115_match_table);

static int lpass_audio_cc_sm6115_probe(struct platform_device *pdev)
{
	...
	regmap = qcom_cc_map(pdev, &lpass_audio_cc_sm6115_desc);
	if (IS_ERR(regmap)) {
		ret = PTR_ERR(regmap);
		goto err_put_rpm;
	}

	clk_alpha_pll_configure(&lpass_audio_cc_dig_pll, regmap, &lpass_audio_cc_dig_pll_config);
	clk_alpha_pll_configure(&lpass_audio_cc_pll, regmap, &lpass_audio_cc_pll_config);

	ret = qcom_cc_really_probe(&pdev->dev, &lpass_audio_cc_sm6115_desc, regmap);
	if (ret) {
...
static int lpass_audio_cc_sm6115_runtime_resume(struct device *dev)
{
...
static int lpass_audio_cc_sm6115_runtime_suspend(struct device *dev)
{
	struct regulator *audio_hm_regulator = dev_get_drvdata(dev);
...
static const struct dev_pm_ops lpass_audio_cc_sm6115_pm_ops = {
	SET_RUNTIME_PM_OPS(lpass_audio_cc_sm6115_runtime_suspend,
				lpass_audio_cc_sm6115_runtime_resume, NULL)
};

static void lpass_audio_cc_sm6115_sync_state(struct device *dev)
{
	qcom_cc_sync_state(dev, &lpass_audio_cc_sm6115_desc);
}

static struct platform_driver lpass_audio_cc_sm6115_driver = {
	.probe = lpass_audio_cc_sm6115_probe,
	.driver = {
		.name = "lpassaudiocc-sm6115",
		.of_match_table = lpass_audio_cc_sm6115_match_table,
		.pm = &lpass_audio_cc_sm6115_pm_ops,
		.sync_state = lpass_audio_cc_sm6115_sync_state,
	},
};

static int __init lpass_audio_cc_sm6115_init(void)
{
	return platform_driver_register(&lpass_audio_cc_sm6115_driver);
}
subsys_initcall(lpass_audio_cc_sm6115_init);

static void __exit lpass_audio_cc_sm6115_exit(void)
{
	platform_driver_unregister(&lpass_audio_cc_sm6115_driver);
}
module_exit(lpass_audio_cc_sm6115_exit);

MODULE_DESCRIPTION("QTI LPASSAUDIOCC SM6115 Driver");
MODULE_LICENSE("GPL");
