...
struct qbam_channel;
/**
 * struct qbam_device - top level device of current driver
...
/* struct qbam_pipe: aggregate of bam pipe related entries of qbam_channel */
struct qbam_pipe {
	u32				index;
...
/*
 * struct bam_channel - dma channel plus bam pipe info and current pending transfers
 *
