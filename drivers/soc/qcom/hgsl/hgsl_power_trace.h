...
#if !defined(_HGSL_POWER_TRACE_H) || defined(TRACE_HEADER_MULTI_READ)
#define _HGSL_POWER_TRACE_H

#undef TRACE_INCLUDE_PATH
#define TRACE_INCLUDE_PATH .
#undef TRACE_INCLUDE_FILE
#define TRACE_INCLUDE_FILE hgsl_power_trace
