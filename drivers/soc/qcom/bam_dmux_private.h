 ...
 * @smsm_put_state_ptr: pointer to smsm_put_state function
 * @sps_connect_ptr: pointer to sps_connect function
 * @sps_disconnect_ptr: pointer to sps_disconnect function
 * @sps_register_bam_device_ptr: pointer to sps_register_bam_device function
 * @sps_deregister_bam_device_ptr: pointer to sps_deregister_bam_device function
 ...
 * @a2_pwr_state: A2 power state tracking variable
 * @pwr_state: pointer to power control state
 * @pwr_ack_state: pointer to power control acknowledgment state
 *
 ...
 * @signal: optional signaling bits with command type specific definitions
 * @cmd: the command
