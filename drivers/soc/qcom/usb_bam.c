...
EXPORT_SYMBOL_GPL(usb_bam_get_pipe_type);
...
EXPORT_SYMBOL_GPL(get_bam2bam_connection_info);
...
EXPORT_SYMBOL_GPL(get_qdss_bam_connection_info);
...
EXPORT_SYMBOL_GPL(usb_bam_get_connection_idx);
...
EXPORT_SYMBOL_GPL(usb_bam_get_bam_type);
