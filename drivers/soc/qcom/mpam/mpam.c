...
#define MPAM_MAX(a, b)		((a) > (b) ? (a) : (b))
#define MPAM_ALGO_STR	0x4D50414D4558544E  /* "MPAMEXTN" */
#define CONFIG_VAL_LEN	MPAM_MAX(sizeof(struct mpam_read_cache_portion), \
							sizeof(struct mpam_config_val))
#define BW_CTRL_LEN		MPAM_MAX(sizeof(struct platform_mpam_read_bw_ctrl), \
