...
bool power_state_hibernate = false;
EXPORT_SYMBOL(power_state_hibernate);
...
static int adsp_start(struct rproc *rproc)
{
	...
	if (((adsp->hyp_assign_mem && !global_sync_mem_setup) || power_state_hibernate) && adsp->pas_id == 18) {
