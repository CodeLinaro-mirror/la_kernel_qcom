...
static const char * const qcs8300_pd_table[] = { "venus", "vcodec0" };

static const char * const qcs8300_opp_pd_table[] = { "mx", "mmcx" };
...
struct iris_platform_data qcs8300_data = {
	...
	.pmdomain_tbl = qcs8300_pd_table,
	.pmdomain_tbl_size = ARRAY_SIZE(qcs8300_pd_table),
