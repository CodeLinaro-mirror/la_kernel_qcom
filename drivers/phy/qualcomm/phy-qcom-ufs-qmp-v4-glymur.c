...
#include "phy-qcom-ufs-qmp-v4-glymur.h"

#define UFS_PHY_NAME "ufs_phy_qmp_v4_glymur"
...
static const struct of_device_id ufs_qcom_phy_qmp_v4_of_match[] = {
	{.compatible = "qcom,ufs-phy-qmp-v4-glymur"},
	{},
};
...
static struct platform_driver ufs_qcom_phy_qmp_v4_driver = {
	...
	.driver = {
		...
		.name = "ufs_qcom_phy_qmp_v4_glymur",
	},
};

module_platform_driver(ufs_qcom_phy_qmp_v4_driver);

MODULE_DESCRIPTION("Universal Flash Storage (UFS) QCOM PHY QMP v4 GLYMUR");
MODULE_LICENSE("GPL");
