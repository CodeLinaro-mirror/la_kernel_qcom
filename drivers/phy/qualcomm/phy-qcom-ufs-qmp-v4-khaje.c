...
#define UFS_PHY_NAME "ufs_phy_qmp_v4_khaje"
...
static const struct phy_ops ufs_qcom_phy_qmp_v4_phy_ops = {
	...
	.calibrate  = ufs_qcom_phy_qmp_v4_phy_calibrate,//TBD
	.owner		= THIS_MODULE,
};
...
static struct platform_driver ufs_qcom_phy_qmp_v4_driver = {
	...
	.driver = {
		...
		.name = "ufs_qcom_phy_qmp_v4_khaje",
	},
};

module_platform_driver(ufs_qcom_phy_qmp_v4_driver);

MODULE_DESCRIPTION("Universal Flash Storage (UFS) QCOM PHY QMP v4 Khaje");
MODULE_LICENSE("GPL");
