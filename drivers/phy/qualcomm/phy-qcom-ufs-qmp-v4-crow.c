...
void ufs_qcom_phy_qmp_v4_tx_hs_equalizer_config(struct ufs_qcom_phy *phy)
{
	 ...
	 * here as in the phy calibration setting.
	 */
...
static struct platform_driver ufs_qcom_phy_qmp_v4_driver = {
	...
	.driver = {
		...
		.name = "ufs_qcom_phy_qmp_v4_crow",
	},
};

module_platform_driver(ufs_qcom_phy_qmp_v4_driver);

MODULE_DESCRIPTION("Universal Flash Storage (UFS) QCOM PHY QMP v4 CROW");
MODULE_LICENSE("GPL");
