...
EXPORT_SYMBOL_GPL(bond_enslave);
...
EXPORT_SYMBOL_GPL(bond_release);
...
EXPORT_SYMBOL_GPL(bond_destroy_mlo);
 ...
 */
struct net_device *bond_create_mlo(struct net *net, const char *name,
...
EXPORT_SYMBOL_GPL(bond_create_mlo);
...
EXPORT_SYMBOL_GPL(bond_get_mlo_ctx);
