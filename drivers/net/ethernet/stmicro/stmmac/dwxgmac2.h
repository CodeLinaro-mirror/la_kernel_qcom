...
#define XGMAC_LPI_AUTO_ENTRY_TIMER	0x000000d8
#define XGMAC_LPI_1US_TIC_COUNTER	0x000000dc
...
#define XGMAC_MAC_EXTENDED_CONFIG		0x00000140
#define XGMAC_MAXEXT_TPRE		BIT(9)
...
#define	XGMAC_VLAN_TAG_CTRL_DELAY	1
#define	XGMAC_VLAN_TAG_CTRL_TIMEOUT	10
...
#define XGMAC_VLAN_TAG_DATA_DMACHEN	BIT(24)
#define XGMAC_VLAN_TAG_DATA_DMACHN	25

/* MAC VLAN CTRL Bit */
#define XGMAC_VLAN_TAG_VID		GENMASK(15, 0)
#define XGMAC_VLAN_TAG_ETV		BIT(16)
#define XGMAC_VLAN_TAG_CTRL_VTIM	BIT(17)
...
#define XGMAC_QxDDMACH(x)		BIT(((x) * 8 + 7) % 32)
...
#define XGMAC_NPE			GENMASK(22, 16)
#define XGMAC_NVE			GENMASK(6, 0)
...
#define XGMAC_TQS			GENMASK(23, 16)
...
#define XGMAC_RQS			GENMASK(22, 16)
...
#define XGMAC_WR_OSR_LMT		GENMASK(28, 24)
#define XGMAC_WR_OSR_LMT_SHIFT		24
#define XGMAC_RD_OSR_LMT		GENMASK(20, 16)
...
#define XGMAC_DMA_INT_COMMON_EN		(XGMAC_DMA_INT_DEFAULT_EN & ~(XGMAC_RIE | XGMAC_TIE))
...
#define XGMAC_RDES3_WDT			0x1
#define XGMAC_RDES3_OVERFLOW		0x7
#define XGMAC_RDES3_CRC			0x3
#define XGMAC_RDES3_DRIBBLE		0xc
#define XGMAC_RDES3_RECEIVE_ERROR	0x2
...
#define XGMAC_LPI_AUTO_RETRY_TIMER	0x1FFF8
/* 1us tic counter */
#define XGMAC_LPI_TIC_COUNTER 0x84
