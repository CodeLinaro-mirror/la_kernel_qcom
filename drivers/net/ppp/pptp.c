...
EXPORT_SYMBOL_GPL(pptp_channel_addressing_get);
...
EXPORT_SYMBOL_GPL(pptp_session_find);
...
EXPORT_SYMBOL_GPL(pptp_session_find_by_src_callid);
...
EXPORT_SYMBOL_GPL(pptp_session_enable_offload_mode);
...
EXPORT_SYMBOL_GPL(pptp_session_disable_offload_mode);
...
EXPORT_SYMBOL_GPL(pptp_register_gre_seq_offload_callback);
...
EXPORT_SYMBOL_GPL(pptp_unregister_gre_seq_offload_callback);
