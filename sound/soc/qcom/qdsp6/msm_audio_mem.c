...
#if 0
static void msm_audio_fd_list_debug(void)
{
...
static void msm_audio_mem_remove(struct platform_device *pdev)
{
...
static int __init msm_audio_mem_init(void)
{
	return platform_driver_register(&msm_audio_mem_driver);
}

static void msm_audio_mem_exit(void)
{
