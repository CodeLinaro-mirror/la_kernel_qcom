...
load(":sa510m.bzl", "define_sa510m")
load(":sa510m_1g.bzl", "define_sa510m_1g")
load(":sdxkova.bzl", "define_sdxkova")
load(":sdxkova_512.bzl", "define_sdxkova_512")
load(":sdxkova_cpe_min.bzl", "define_sdxkova_cpe_min")
load(":sdxkova_cpe_tarang.bzl", "define_sdxkova_cpe_tarang")
load(":sdxkova_cpe_wkk.bzl", "define_sdxkova_cpe_wkk")
load(":sdxkova_prpl.bzl", "define_sdxkova_prpl")
load(":sdxkova_prpl_min.bzl", "define_sdxkova_prpl_min")
...
def define_msm_platforms():
    ...
    define_sdxkova()
    define_sdxkova_cpe_min()
    define_sdxkova_cpe_tarang()
    define_sdxkova_cpe_wkk()
    define_sdxkova_prpl()
    define_sdxkova_prpl_min()
    define_sdxkova_512()
    define_sun()
    define_sun_tuivm()
    define_sun_oemvm()
