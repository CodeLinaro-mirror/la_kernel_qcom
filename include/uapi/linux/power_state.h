...
#define POWER_STATE_SOCCP_SUSPEND 6
#define POWER_STATE_MODEM_EXIT 7
#define POWER_STATE_ADSP_EXIT 8
#define POWER_STATE_CDSP_EXIT 9
#define POWER_STATE_SOCCP_EXIT 10
#define POWER_STATE_EXIT_DEEPSLEEP_STATE 11
#define POWER_STATE_EXIT_HIBERNATE_STATE 12
...
#define SOCCP_SUSPEND _IOWR(EXCHANGE_CODE, POWER_STATE_SOCCP_SUSPEND, __u32*)
...
#define SOCCP_EXIT _IOWR(EXCHANGE_CODE, POWER_STATE_SOCCP_EXIT, __u32*)
