...
#define AUDIO_CORE_CC_DIG_PLL					0
#define AUDIO_CORE_CC_DIG_PLL_OUT_AUX				1
#define AUDIO_CORE_CC_DIG_PLL_OUT_AUX2				2
...
#define AUDIO_CORE_CC_AIF_IF0_BCR				0
#define AUDIO_CORE_CC_AIF_IF1_BCR				1
#define AUDIO_CORE_CC_AIF_IF2_BCR				2
#define AUDIO_CORE_CC_AIF_IF3_BCR				3
#define AUDIO_CORE_CC_AUDIO_CORE_HM_AUD_DMA_BCR			4
#define AUDIO_CORE_CC_AUDIO_CORE_HM_BUS_CLK_BCR			5
#define AUDIO_CORE_CC_CODEC_MCLK_BCR				6
#define AUDIO_CORE_CC_EXT_MCLKA_BCR				7
#define AUDIO_CORE_CC_EXT_MCLKB_BCR				8
#define AUDIO_CORE_CC_IM_SLEEP_CLK_BCR				9
#define AUDIO_CORE_CC_PCM_DATA_OE_BCR				10
