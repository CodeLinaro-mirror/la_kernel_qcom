...
extern int br_vlan_update_stats(struct net_device *dev, u32 vid,
				 u64 rx_bytes, u64 rx_packets, u64 tx_bytes, u64 tx_packets);
extern int br_vlan_get_info_rcu(const struct net_device *dev, u16 vid,
				 struct bridge_vlan_info *p_vinfo);
#else
...
static inline int br_vlan_update_stats(struct net_device *dev, u32 vid,
				       u64 rx_bytes, u64 rx_packets, u64 tx_bytes, u64 tx_packets)
{
	return -EINVAL;
}
