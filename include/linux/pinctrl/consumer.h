...
extern int pinctrl_gpio_get_config(unsigned int gpio, unsigned long *config);
...
static inline int pinctrl_gpio_get_config(unsigned int gpio, unsigned long *config)
{
	return 0;
}
