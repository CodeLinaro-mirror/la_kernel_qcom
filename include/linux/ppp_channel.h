...
struct ppp_channel_ops {
	 ...
	 * the channel subtype
	 */
	int (*get_channel_protocol)(struct ppp_channel *chan);
	/* Get channel protocol version */
	int (*get_channel_protocol_ver)(struct ppp_channel *chan);
	/* Hold the channel from being destroyed */
	void (*hold)(struct ppp_channel *chan);
	/* Release hold on the channel */
	void (*release)(struct ppp_channel *chan);
};
...
extern int ppp_channel_get_proto_version(struct ppp_channel *chan);

/* Call this to hold a channel */
extern bool ppp_channel_hold(struct ppp_channel *chan);

/* Call this to release a hold you have upon a channel */
extern void ppp_channel_release(struct ppp_channel *chan);
...
extern int ppp_dev_index(struct ppp_channel *chan);
