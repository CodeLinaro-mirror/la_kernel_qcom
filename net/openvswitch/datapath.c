...
EXPORT_SYMBOL_GPL(ovs_register_accelerator);
...
EXPORT_SYMBOL_GPL(ovs_unregister_accelerator);
...
EXPORT_SYMBOL_GPL(ovs_accel_flow_find_by_mac);
...
EXPORT_SYMBOL_GPL(ovs_accel_flow_stats_update);
...
EXPORT_SYMBOL_GPL(ovs_accel_dev_find);
...
EXPORT_SYMBOL_GPL(ovs_accel_egress_dev_find);
