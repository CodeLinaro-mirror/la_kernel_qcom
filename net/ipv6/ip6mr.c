...
EXPORT_SYMBOL_GPL(ip6mr_register_mfc_event_offload_callback);
...
EXPORT_SYMBOL_GPL(ip6mr_unregister_mfc_event_offload_callback);
...
EXPORT_SYMBOL_GPL(ip6mr_find_mfc_entry);
...
EXPORT_SYMBOL_GPL(ip6mr_mfc_stats_update);
