...
#define EMBMS_UDP_CHECKSUM          0
#define EMBMS_IP_VERSION            4
#define EMBMS_IP_IHL                5
#define EMBMS_IP_ID                 1
#define EMBMS_IP_FRAG_OFFSET        htons(0x4000)
#define EMBMS_IP_TOS                0
#define EMBMS_IP_TTL                64
