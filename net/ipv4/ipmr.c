...
EXPORT_SYMBOL_GPL(ipmr_register_mfc_event_offload_callback);
...
EXPORT_SYMBOL_GPL(ipmr_unregister_mfc_event_offload_callback);
...
EXPORT_SYMBOL_GPL(ipmr_find_mfc_entry);
...
EXPORT_SYMBOL_GPL(ipmr_mfc_stats_update);
