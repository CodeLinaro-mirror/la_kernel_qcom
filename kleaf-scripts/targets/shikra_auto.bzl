load(":configs/shikra_auto_consolidate.bzl", "shikra_auto_consolidate_config")
load(":configs/shikra_auto_perf.bzl", "shikra_auto_perf_config")
...
def define_shikra_auto():
    ...
    define_typical_android_build(
        name = "shikra_auto",
        consolidate_config = shikra_auto_consolidate_config,
        perf_config = shikra_auto_perf_config,
        consolidate_build_img_opts = consolidate_build_img_opts,
        perf_build_img_opts = perf_build_img_opts,
        consolidate_kwargs = {
            "config_path": "configs/shikra_auto_consolidate.bzl",
        },
        perf_kwargs = {
            "config_path": "configs/shikra_auto_perf.bzl",
        },
    )
